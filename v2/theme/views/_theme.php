<?php
$dadosSeller = (new \Source\App\User\ControllerSessionUsers())->getDataUserLogged();
?>
<!doctype html>
...
<head>
    ...
    <!-- Dashboard css -->
    <link href="<?= url("theme/"); ?>assets/css-dark/style.css" rel="stylesheet" />

    <!-- Custom scroll bar css-->
    <link href="<?= url("theme/"); ?>assets/plugins/scroll-bar/jquery.mCustomScrollbar.css" rel="stylesheet" />

    <!-- Sidemenu css -->
    <link href="<?= url("theme/"); ?>assets/plugins/toggle-sidebar/dark-full-sidemenu.css" rel="stylesheet" />

    <!--Daterangepicker css-->
    <link href="<?= url("theme/"); ?>assets/plugins/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet" />

    <!-- Sidebar Accordions css -->
    <link href="<?= url("theme/"); ?>assets/plugins/accordion1/css/dark-easy-responsive-tabs.css" rel="stylesheet">

    <!-- Rightsidebar css -->
    <link href="<?= url("theme/"); ?>assets/plugins/sidebar/dark-sidebar.css" rel="stylesheet">

    <!---Font icons css-->
    <link href="<?= url("theme/"); ?>assets/plugins/iconfonts/plugin.css" rel="stylesheet" />
    <link href="<?= url("theme/"); ?>assets/plugins/iconfonts/icons.css" rel="stylesheet" />
    <link  href="<?= url("theme/"); ?>assets/fonts/fonts/font-awesome.min.css" rel="stylesheet">
...
<div id="global-loader">
    <img src="<?= url("theme/"); ?>assets/images/icons/loader.svg" alt="loader">
</div>
    ...
    <div class="page-main">
            ...
            <div class="container-fluid">
                <div class="d-flex">
                    <a class="header-brand" href="index.html">
                        <img src="<?= url("theme/"); ?>assets/images/brand/logo1.png" class="header-brand-img main-logo" alt="Hogo logo">
                        <img src="<?= url("theme/"); ?>assets/images/brand/icon.png" class="header-brand-img icon-logo" alt="Hogo logo">
                    </a><!-- logo-->
                                                ...
                                                <div class="card-body p-0">
                                                    <div class="list-group list-lg-group list-group-flush">
                                                        <a class="list-group-item list-group-item-action overflow-hidden pl-0 pr-0 pb-4" href="#">
                                                            <div class="d-flex">
                                                                <img class="avatar-xl br-7 mr-3" src="<?= url("theme/"); ?>assets/images/photos/33.jpg" alt="Image description">
                                                        ...
                                                        <a class="list-group-item list-group-item-action overflow-hidden pl-0 pr-0 pt-4" href="#">
                                                            <div class="d-flex">
                                                                <img class="avatar-xl br-7 mr-3" src="<?= url("theme/"); ?>assets/images/photos/34.jpg" alt="Image description">
                                                                <div class="media-body">
                                                                    <div class="align-items-center">
                                                                        <h5 class="mb-0">
                                                                            Html project
                    ...
                    <div class="d-flex order-lg-2 ml-auto header-rightmenu">
                        ...
                        <div class="dropdown header-user">
                            <a class="nav-link leading-none siderbar-link"  data-toggle="sidebar-right" data-target=".sidebar-right">
                                ...
                                <span class="avatar avatar-md brround"><img src="<?= url("theme/"); ?>assets/images/users/female/33.png" alt="Profile-img" class="avatar avatar-md brround"></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <div class="header-user text-center mt-4 pb-4">
                                    <span class="avatar avatar-xxl brround"><img src="<?= url("theme/"); ?>assets/images/users/female/33.png" alt="Profile-img" class="avatar avatar-xxl brround"></span>
        ...
        <aside class="app-sidebar">
            <div class="app-sidebar__user pb-0">
                <div class="user-body">
                    <span class="avatar avatar-xxl brround text-center cover-image" data-image-src="<?= url("theme/"); ?>assets/images/users/female/33.png"></span>
                </div>
                <div class="user-info">
                                    ...
                                    <div class="col-xl-3 collg-12 col-md-12">
                                        <div class="clearfix mb-4">
                                            ...
                                            <div class="float-right text-right mt-1">
                                                <span class="pie" data-peity='{ "fill": ["#313c4a", "#1753fc"]}'>2/5</span>
                                            </div>
                                        </div>
                                        <div class="clearfix mb-4">
                                            <div class="float-left">
                                            ...
                                            <div class="float-right text-right mt-1">
                                                <span class="pie" data-peity='{ "fill": ["#ff6666", "#313c4a"]}'>226,134</span>
                                            </div>
                                        </div>
                                        <div class="clearfix mb-4">
                                            <div class="float-left">
                                            ...
                                            <div class="float-right text-right mt-1">
                                                <span class="pie" data-peity='{ "fill": ["#7d41de", "#313c4a"]}'>1.22,1.041</span>
                                            </div>
                                        </div>
