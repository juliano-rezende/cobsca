...
<section id="introduction" class="gradient-violat padding-top-90 home-slider">
    <div id="home-slider" class="owl-carousel">
        <div>
            <div class="sliding-card-with-bottom-image text-center padding-top-90">
                ...
                <div class="image-container text-center sm-display-none">
                    <img class="img-responsive" src="<?=url("theme/site");?>/assets/images/mockuo2.png" alt="">
                </div>
            </div>
        </div>
        ...
        <div>
            <div class="container">
                <div class="row">
                    <div class="image-right-slide-bg clearfix" style="background-image:url(<?=url("theme/site");?>/assets/images/mockuo.png)">
                        <div class="col-md-12">
                            <h2 class="cta-heading text-white">Lazy Fox HTML5 Landing page</h2>
...
<section id="feature" class="padding-top-bottom-120 bg-image-fit-50" style="background:url(<?=url("theme/site");?>/assets/images/1_back.png)">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
...
<section id="services" class="padding-top-90">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <img class="img-responsive sm-display-none" src="<?=url("theme/site");?>/assets/images/hand_phone.png" alt="">
            </div>
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-6">
...
<section id="blog-card" class="padding-top-bottom-90">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top img-responsive max-width-100" src="<?=url("theme/site");?>/assets/images/b1.png" alt="Card image cap">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top img-responsive max-width-100" src="<?=url("theme/site");?>/assets/images/b2.png" alt="Card image cap">
                    <div class="card-block">
                        <p class="card-text"><small class="text-muted blog-category">web design</small></p>
                        <h4 class="card-title">Make your website with best web Tools.</h4>
                        <p class="card-text"><small class="text-muted italic">21<sup>st</sup> jun 2016</small></p>
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top img-responsive max-width-100" src="<?=url("theme/site");?>/assets/images/b3.png" alt="Card image cap">
                    <div class="card-block">
                        <p class="card-text"><small class="text-muted blog-category">web design</small></p>
                        <h4 class="card-title">Make your website with best web Tools.</h4>
                        <p class="card-text"><small class="text-muted italic">21<sup>st</sup> jun 2016</small></p>
                    ...
                    <div>
                        <div class="testimonial-container">
                            <div class="client-details text-center">
                                <img src="<?=url("theme/site");?>/assets/images/t-1.png" alt="">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="image-wraper">
                <img class="img-responsive" src="<?=url("theme/site");?>/assets/images/support.png" alt="">
            </div>
        </div>
        <div class="col-md-5">
...
<section id="newsletter" class="padding-top-bottom-120 newsletter">
    <div class="container">
        <div class="row">
            <div class="col-md-8 sunscription-wraper-outer col-md-offset-2 bg-fit" style="background:url(<?=url("theme/site");?>/assets/images/newsletter.png)">
                <div class="row">
