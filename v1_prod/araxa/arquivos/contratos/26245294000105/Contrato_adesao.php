...
$dadosassociado= associados::find_by_sql("SELECT
										  ...
										  empresas.logomarca,
										  (
										  SELECT CONCAT(logradouros.complemento,' ',logradouros.descricao,' cep: ',SUBSTR(logradouros.cep,1,2),'.',SUBSTR(logradouros.cep,3,3),'-',SUBSTR(logradouros.cep,5,3),' Num ',empresas.num,' A , ', bairros.descricao,', ', cidades.descricao,'/', estados.sigla)
										  FROM
										  empresas
...
Este benefício tem como estipulante a empresa LÍDER COBRANÇAS E SERVIÇOS CNPJ: 26.245.294/0001-05 o qual está acobertada pela SANCOR SEGUROS - CNPJ: 17.643.407/0001-30, com as seguintes regras: 
</p>
...
<p style="font-size: 9pt; text-align: justify;">
7.2.  Só será incluso dependentes, cônjugue e filhos com idade de 0 a 21 anos para terem direito ao benefício do auxílio funeral.
</p>
...
<p style="font-size: 9pt; text-align: justify;">
11. Para comunicado de sinistro o associado deverá entrar em contato com a seguradora pelo telefone 0800 200 0395 e informar o número da apólice, nome, CPF do assegurado.
</p>
...
<p style="font-size: 9pt; text-align: justify;">
15. A forma de cobrança poderá ser feita através de boleto bancário, cartão de crédito, anual à vista. A mensalidade deverá estar em dia com a LÍDER COBRANÇAS E SERVIÇOS para poder usufruir dos serviços oferecidos pela UNICLÍNICA E SANCOR SEGUROS E PREVIDÊNCIA, independente do uso.
</p>
...
<?php echo strtolower($dadosassociado[0]->endereco_emp." ".tool::DataAtualExtenso(1)); ?>
</p>
