...
$logradouros_encontrados=logradouros::find_by_sql("SELECT descricao,id,complemento FROM logradouros WHERE bairros_id='".$_POST['cdbairro']."' GROUP BY descricao ORDER BY descricao ASC");
