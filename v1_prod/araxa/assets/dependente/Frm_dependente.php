...
<a  id="Btn_dep_1" class="uk-button uk-button-primary" style="right: 10px; margin-right:5px; width: 120px;bottom:35px; position:absolute; z-index: 2;" data-uk-tooltip="{pos:'left'}" title="Salvar Alterações" data-cached-title="Salvar Alterações" ><i class="uk-icon-pencil "></i> Salvar</a>

<a  id="Btn_dep_2" class="uk-button uk-button-primary" style=" right: 10px; margin-right:5px;width: 120px;bottom:35px; position:absolute;z-index: 2;" data-uk-tooltip="{pos:'left'}" title="Gravar Novo " data-cached-title="Gravar Novo " ><i class="uk-icon-floppy-o"></i> Gravar</i></a>
 ...
 jQuery.ajax({
				...
				success: function(resultado) {
		                        ...
		                        /* se for = 0 indica que houve erro ai retornamo o erro na tela do usuario*/
		                            ...
		                            New_window('users','780','500','Dependentes','assets/dependente/Veiw_dependente.php?matricula='+obj.matricula+'',true,false,'Carregando...');
