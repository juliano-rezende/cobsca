...
<fieldset style="width:758px; left:5px; top:70px; position:absolute;">
    ...
    <input value="<?php  if(isset($dadosconta)):echo $dadosconta[0]->cod_cedente;endif; ?>"  name="cod_cedente" type="text" class="w_100 uk-text-center" id="cod_cedente"  />
             ...
             class="w_20 " id="dv_cod_ced"  /> <div class="uk-badge uk-text-warning" style="background-color:transparent;">Não havendo digito deixar em branco.<br>
    ...
    | Aceite | <select class="select w_80" name="aceite"  id="aceite" >
        <?php
      if(isset($dadosconta)){
            if($dadosconta[0]->aceite=="S"){
                  echo'<option value="S" selected="selected">S - Sim</option>';
                  echo'<option value="N">N - Não</option>';
            }else{
                  echo'<option value="S">S - Sim</option>';
                  echo'<option value="N" selected="selected">N - Não</option>';
            }
