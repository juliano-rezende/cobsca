...
// blibliotecas
  ...
  $dadosProcedimentos=med_proc_autorizacoes::find_by_sql("SELECT med_proc_autorizacoes.*,med_procedimentos.descricao AS descpro FROM med_proc_autorizacoes LEFT JOIN med_procedimentos ON med_proc_autorizacoes.med_procedimentos_id = med_procedimentos.id LEFT JOIN med_autorizacoes ON med_proc_autorizacoes.med_autorizacoes_id = med_autorizacoes.id LEFT JOIN med_areas ON med_autorizacoes.med_areas_id = med_areas.id WHERE med_proc_autorizacoes.med_autorizacoes_id='".$FRM_aut_id."'");


    $procedimentos= new ArrayIterator($dadosProcedimentos);
    while($procedimentos->valid()):

     $FRM_procedimentos_aut.=$procedimentos->current()->descpro." | ";
  ...
  <div class="uk-grid uk-grid-small " data-uk-grid-match >
    ...
    <div class="uk-width-2-10">
      <div class="uk-panel uk-panel-box" >
        ...
        <span class="span2 uk-text-uppercase"><?php echo "Exames"; ?></span>            
      </div>
    </div>            
    <div class="uk-width-6-10">
      <div class="uk-panel uk-panel-box" >
        <span class="span1">15- Procedimentos </span><br>
        <span class="span2 uk-text-uppercase">| <?php echo $FRM_procedimentos_aut;?></span>            
      </div>
    </div>
  </div>
