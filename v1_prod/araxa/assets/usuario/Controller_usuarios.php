...
if($COB_Acesso_Id != 6){tool::msg_erros("Alterações de Usuarios só são Permitidas por Adminstradores.");}
...
$FRM_empresa_id			= isset( $_POST['empresa_id']) 			? $_POST['empresa_id'] 		 : tool::msg_erros("Erro campo empresa é Obrigatorio.");
$FRM_convenios_id		= isset( $_POST['convenio']) 			? $_POST['convenio'] 		 : tool::msg_erros("Erro campo convenio é Obrigatorio.");
...
$FRM_salt				=	isset( $_POST['slt'])					? $_POST['slt']  			 	: tool::msg_erros("Erro campo st é Obrigatorio.");
...
$FRM_status				=	isset( $_POST['st'])					? $_POST['st']  		 		: tool::msg_erros("Erro campo status é Obrigatorio.");
$FRM_notificar 			=	isset( $_POST['notificar'])				? $_POST['notificar']  		 	: tool::msg_erros("Erro campo notificar é Obrigatorio.");
$FRM_faturamento		=	isset( $_POST['fat'])					? $_POST['fat']  		 		: tool::msg_erros("Erro campo faturamento é Obrigatorio.");
