...
<input value="<?php  if(isset($dadosusuario)):echo $dadosusuario->salt; endif; ?>"   name="slt" type="hidden" id="slt"  />
...
echo tool::CompletaZeros(3,$dadosusuario->id); endif; ?>"  name="usuario_id" type="text" class="w_80 uk-text-center  <?php echo $subclasse; ?>" readonly id="usuario_id"  />
  ...
  <label>
          ...
          <select class="select w_400" name="convenio" id="convenio" >
              ...
              if($descricao->current()->id == $dadosusuario->convenios_id){$select='selected="selected"';}else{$select="";}
...
<label>
<span>Senha </span>
<!-- <a href="" class="uk-form-password-toggle" data-uk-form-password="" style="margin:20px 560px;">Show</a> -->
...
<select name="access" id="access" class="select w_150">
...
<label>
<span>Expirar Senha ?</span>
<select name="password_expires" id="password_expires" class="select w_150">
<?php
if(isset($dadosusuario)):
...
<label>
<span>Data Expira</span>
<div class="uk-form-icon">
<i class="uk-icon-calendar-o"></i>
<input name="date_expires_pass" type="text" class="w_150 uk-text-center" id="date_expires_pass" placeholder="00/00/0000" data-uk-datepicker="{format:'DD/MM/YYYY'}" value="<?php
if(isset($dadosusuario)):
...
<label>
<span>Notificar</span>
<select name="notificar" id="notificar" class="select w_150">
<?php
if(isset($dadosusuario)):
...
?>
</select><div class="uk-badge uk-text-warning" style="background-color:transparent;">Este Usuario irá receber notificações do sistema ?</div>
</label>
</fieldset>
...
<label >
  ...
  <label >
    <input type="radio"  name="st" value="1" <?php  if(isset($dadosusuario)){if($dadosusuario->status == "1"){echo"checked";} }?> > Ativo
    <input type="radio"  name="st" value="0" <?php  if(isset($dadosusuario)){if($dadosusuario->status == "0"){echo"checked";} }?> > Inativo
  </label>
  </div>
</label>
...
<label>
  ...
  <div class="uk-form-controls">
  <label >
    <input type="radio"  name="fat" value="1" <?php  if(isset($dadosusuario)){if($dadosusuario->faturamento == "1"){echo"checked";} }?> > Sim
    <input type="radio"  name="fat" value="0" <?php  if(isset($dadosusuario)){if($dadosusuario->faturamento == "0"){echo"checked";} }?> > Não
    <div class="uk-badge uk-text-warning" style="background-color:transparent;">Permissão para gerar faturamento.</div>
  </label>
  </div> 
</label>
...
<select name="day_acs_user" id="day_acs_user" class="select w_150">
<?php if(isset($dadosusuario)):?>

<option value="1111111" <?php if($dadosusuario->day_access_user == 0000000){echo'selected="selected"';} ?>></option>
<option value="1000000" <?php if($dadosusuario->day_access_user == 1000000){echo'selected="selected"';} ?>>Seg</option>
<option value="1100000" <?php if($dadosusuario->day_access_user == 1100000){echo'selected="selected"';} ?>>Seg / Ter</option>
<option value="1110000" <?php if($dadosusuario->day_access_user == 1110000){echo'selected="selected"';} ?>>Seg / Ter / Qua</option>
<option value="1111000" <?php if($dadosusuario->day_access_user == 1111000){echo'selected="selected"';} ?>>Seg / Ter / Qua / Qui</option>
<option value="1111100" <?php if($dadosusuario->day_access_user == 1111100){echo'selected="selected"';} ?>>Seg / Ter / Qua / Qui / Sex</option>
<option value="1111110" <?php if($dadosusuario->day_access_user == 1111110){echo'selected="selected"';} ?>>Seg / Ter / Qua / Qui / Sex / Sab</option>
<?php
else:
?>
...
</select><div class="uk-badge uk-text-warning" style="background-color:transparent;">Dias liberado para acesso.</div>
</label>


<label>
<span>1º horario</span>
<input name="interval_am" type="text" class="w_150 uk-text-center" id="interval_am" placeholder="00:00 - 00:00"  value="<?php
if(isset($dadosusuario)):
...
<label>
<span>2º Horario</span>
<input name="interval_pm" type="text" class="w_150 uk-text-center" id="interval_pm" placeholder="00:00 - 00:00" value="<?php
if(isset($dadosusuario)):
...
<div class="uk-form-icon">
<i class="uk-icon-calendar-o"></i>
<input name="datacadastro" type="text" class="w_150 uk-text-center" id="datacadastro" value="<?php
if(isset($dadosusuario)):
