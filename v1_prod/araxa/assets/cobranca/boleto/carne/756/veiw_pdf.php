...
<table width="100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="99%" height="100%" border="0" cellspacing="0" style=" border-bottom:0.2mm solid #000;">
      <tr>
        ...
        <img src="../../imagens/756.jpg" alt="Sicoob" width="91" height="22" style="padding:1px;">
        </td>
  ...
  <tr>
    ...
    <table width="90%"  border="0" cellpadding="0" cellspacing="0" style="max-width:90%;" >
      ...
      <tr>
        <td height="20" align="right" valign="bottom" class="cp" style=" border-left: #000000 0.1mm solid;padding-right:5px; " >'.$dadosboleto["agencia_codigo"].'</td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="20" align="right" class="cp" style=" border-left: #000000 0.1mm solid;padding-right:5px;"  >'.$dadosboleto["nosso_numero"].'</td>
      </tr>
      <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:0; padding:0;">
      <tr>
        <td width="87%" align="right" ><table width="99%"  border="0" cellpadding="0" cellspacing="0" style="padding:0; margin:0;" >
          <tr>
        ...
        <td width="100" rowspan="7" align="right" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0" style="max-width:90%;" >
          ...
          <tr>
            <td height="25" align="right" valign="bottom" class="cp" style=" border-left: #000000 0.1mm solid;padding-right:5px; " >'.$dadosboleto["agencia_codigo"].'</td>
          </tr>
          <tr >
            <td align="left" class="ct" style=" border-left: #000000 0.1mm solid;  border-top: #000 0.1mm solid;">Nosso Numero</td>
          </tr>
          <tr>
            <td height="25" align="right" class="cp" style=" border-left: #000000 0.1mm solid;padding-right:5px;"  >'.$dadosboleto["nosso_numero"].'</td>
          </tr>
          <tr>
      ...
      <tr>
        <td align="right" valign="top"><table width="99%"  border="0" cellpadding="0" cellspacing="0" style="padding:0;" >
          ...
          <tr>
            ...
            <td height="20" align="left" valign="bottom" class="cp" style="border-right:#ccc 1px solid;border-bottom:#ccc 1px solid; text-transform: uppercase; " >'.$dadosboleto["carteira"].'</td>
...
//echo $html;
if($FRM_action =='D'){
$mpdf->Output($dadosboleto["sacado"]."_".date("dmY")."_bol.pdf",'D');
}elseif($FRM_action =='E'){
$mpdf->Output();
}else{
$mpdf->Output();
