...
//
//Guarda inicial
?><img src=assets/cobranca/boleto/imagens/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src=assets/cobranca/boleto/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src=assets/cobranca/boleto/imagens/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src=assets/cobranca/boleto/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src=assets/cobranca/boleto/imagens/p.png width=<?php echo $f1?> height=<?php echo $altura?> border=0><img
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src=assets/cobranca/boleto/imagens/b.png width=<?php echo $f2?> height=<?php echo $altura?> border=0><img
<?php
  }
}
...
// Draw guarda final
?>
src=assets/cobranca/boleto/imagens/p.png width=<?php echo $largo?> height=<?php echo $altura?> border=0><img
src=assets/cobranca/boleto/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src=assets/cobranca/boleto/imagens/p.png width=<?php echo 1?> height=<?php echo $altura?> border=0>
  <?php
} //Fim da função


// codigo de barras pds
function fbarcode_pdf($valor){
...
src="../../imagens/b.png" width="1" height="'.$altura.'" border="0"><img ';
...
$html.='src="../../imagens/p.png" width="'.$f1.'" height="'.$altura.'" border="0"><img ';
...
$html.=' src="../../imagens/b.png" width="'.$f2.'" height="'.$altura.'" border="0"><img ';
...
$html.='src="../../imagens/p.png "width="'.$largo.'" height="'.$altura.'"  border="0"><img ';
$html.='src="../../imagens/b.png" width="'.$fino.'"  height="'.$altura.'"  border="0"><img ';
$html.='src="../../imagens/p.png" width="1" height="'.$altura.'"  border="0"> ';
