...
if($FRM_action == "pay"){
    ...
    /********************************************** lançamentos no caixa  **********************************************************************************/
      ...
      $Query_update_titulo->update_attributes(
                                            array(
                                                ...
                                                'dt_atualizacao' =>date("Y-m-d"),
                                                'vlr_pago'       =>$vlr_valor_pago,
                                                'cod_mov_rem'    =>remessas::Cod_Tab_Remessa(033,"MOV02"), /* codigo de movimentação interna do sistema para controle e baixa de titulos sem registro */
                                                'mov_manual'     =>"S",
  ...
  $Query_update_titulo->update_attributes(
                                        array(
                                            ...
                                            'dt_atualizacao' =>date("Y-m-d"),
                                            'cod_mov_rem'    =>remessas::Cod_Tab_Remessa(033,"MOV13"), /* MOV13- titulo Codigo interno sistema */
                                            'mov_manual'     =>"S",
