...
$FRM_Convenios_id = " AND associados.convenios_id='".$COB_Convenio_Id."'";
...
if(ctype_alpha(tool::limpaString($_POST['vl']))) {
    ...
    $where      = " AND dependentes.nome LIKE '".$_POST['vl']."%'".$FRM_Convenios_id;

}elseif (is_numeric ($_POST['vl'])){

    $where      = " AND dependentes.matricula ='".tool::limpaString($_POST['vl'])."'".$FRM_Convenios_id;
...
$query="SELECT SQL_CACHE
		...
		WHERE empresas_id='".$COB_Empresa_Id."'
		  ".$where."";
    ...
    <article class="uk-comment">
        <header class="uk-comment-header " style="padding: 5px;">
            ...
            <h4 class="uk-comment-title uk-text-bold">
				 <?php
					 echo utf8_encode($associados->current()->nm_dependente." - [ ".$associados->current()->nm_convenio." ]");
            ...
            <div class="uk-comment-meta uk-text-bold " style="height:30px;">
           		Titular: <?php echo strtoupper(utf8_encode($associados->current()->nm_associado)); ?> |
