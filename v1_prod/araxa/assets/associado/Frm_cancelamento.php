...
<form method="post" id="FrmCancelamento" class="uk-form" style="padding-top:0;margin:0;">
    ...
    <label>
        ...
        <select class="select w_400" name="motivo"  id="motivo" >
            ...
            echo'<option value="'.$array_motivos->current()->id.'" >'.utf8_encode(strtoupper($array_motivos->current()->descricao)).'</option>';
    ...
    <label>
       ...
       <a  id="Btn_cancel_0" class="uk-button uk-button-primary" style=" bottom:33px; position:absolute;  right:15px;" data-uk-tooltip="{pos:'left'}" title="Confirmar" data-cached-title="Confirmar" ><i class="uk-icon-check"></i> Confirmar </a>
