...
<fieldset style="width:350px; background-color:transparent;padding-top:0;margin:0;">
    ...
    <label>
        ...
        <input type="hidden" id="parcelas" value="<?php echo $FRM_ids; ?>" />
        <input type="hidden" id="matricula" value="<?php echo $FRM_matricula; ?>" />
    </label>
    <label>
        <span>Vl Parcelas</span>
        <div class="uk-form-icon">
        <i class="uk-icon-money "></i>
        <input name="vtotalparcelas" type="text" class=" w_150 uk-text-center"   id="vtotalparcelas" value="<?php echo number_format($vl_t_parcelas,2,",",".") ; ?>" readonly="readonly"  />
        </div>
    </label>
    <label>
     ...
     <label>
        ...
        <input  type="text" id="vl_n" class=" w_150 uk-text-center uk-text-primary"  value="<?php echo number_format($vl_t_parcelas+$jurosemulta,2,",","."); ?>" readonly="readonly" />
        </div>
    </label>
<hr />
    <label>
        <span>Negociar ? </span>
        <select name="neg" id="neg" class="select" <?php if($jurosemulta <= 0 ){echo 'disabled';}; ?>>
        <option value="0" selected>Não</option>
        <option value="1" >	Sim </option>
        </select>
        <select name="desc_conced" id="desc_conced" class="select w_150" disabled >
...
<hr />
    ...
    <span>Forma Receb</span>
        <select name="f_receb" id="f_receb" class="select w_150">
    ...
    <label id="label_doc_cartao">
        <span>Nº doc/cheque</span>
        <input name="num_doc_c"   type="text" class=" w_150 uk-text-center " id="num_doc_c"  />
    </label>
    <label>
        <span>descontos</span>
        <div class="uk-form-icon">
        <i class="uk-icon-minus uk-text-danger"></i>
        <input name="descontos" <?php /*if($jurosemulta <= 0 ){echo 'readonly';};*/ ?>  type="text" class=" w_150 uk-text-center " id="descontos" value="0,00" onkeyup="if ((window.event ? event.keyCode : event.which) == 13) { Calcular(); }" onblur ="Calcular();" />
    ...
    <label>
        ...
        <i class="uk-icon-money uk-text-success"></i>
                <input name="ttpg"  type="text" readonly class=" w_150 uk-text-center uk-text-success" id="ttpg"  value="<?php  echo number_format($vl_t_parcelas+$jurosemulta,2,",","."); ?>"  />
        </div>
    </label>
        ...
        <div class="uk-modal-dialog" >
            ...
            <h2><i class="uk-icon-bank" ></i> Banco/Vencimento</h2>
                ...
                <label>
                    ...
                    <select name="banco_emissor" id="banco_emissor" class="select w_200">
                    <?php
                    while($conta->valid()):
                ...
                <label>
                    ...
                    <input  type="text" class=" w_150 center" name="dt_vencimento" id="dt_vencimento" placeholder="00/00/0000"/>
                </label>
    ...
    <a  id="Btn_Rec_2" class="uk-button uk-button-primary" style=" bottom:35px; position:absolute;  right:15px;" data-uk-tooltip="{pos:'left'}" title="Receber" data-cached-title="Receber" ><i class="uk-icon-bank"></i> Receber </a>
...
jQuery("#descontos,#ttpg").maskMoney({showSymbol:true, symbol:"", decimal:",", thousands:"."});
