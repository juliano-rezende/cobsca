...
<div class="uk-alert uk-alert-warning center" style="font-size:10px; border-radius: 0;">
...
<fieldset style="width:300px;">
  ...
  <label>
    ...
    <a  id="Btn_Gp_1" class="uk-button uk-button-primary" style="position:absolute;; right:15px; bottom:35px;" data-uk-tooltip="{pos:'left'}" title="Confirmar Parcelas" data-cached-title="Confirmar Parcelas" ><i class="uk-icon-check"></i> Confimar</a>
