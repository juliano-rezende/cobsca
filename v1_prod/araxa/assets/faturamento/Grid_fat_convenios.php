...
$FRM_subconvenio    = isset( $_GET['subconvenio'])    ? $_GET['subconvenio']            : tool::msg_erros("O Campo subconvenio é Obrigatorio.");
...
<div id="DadosGeraTitulo" class="uk-modal">
    <div class="uk-modal-dialog" style="width:500px;">
        ...
        <h2><i class="uk-icon-bank" ></i> Banco / Vencimento</h2>
            ...
            <input type="hidden" readonly="readonly" value="<?php  echo $FRM_subconvenio; ?>" id="subConvenio" />
    ...
    jQuery("#Btn_fat_9").click(function(event) {
        ...
        jQuery.ajax({
                   async: true,
                    ...
                    type: "POST",
                    data: "convenio_id=<?php echo $FRM_convenio_id; ?>&subconvenio=<?php echo $FRM_subconvenio; ?>&ids="+ids+"&valor="+jQuery("#vl_t_title").val()+"&vencimento="+jQuery("#dt_venc_titulo_pj").val()+"&conta_bancaria_id="+jQuery("#conta_bancaria").val()+"",
