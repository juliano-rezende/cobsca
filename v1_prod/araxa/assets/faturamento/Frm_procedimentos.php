...
<a  id="Btn_proc_0" class="uk-button uk-button-primary" style=" bottom:40px; position:absolute;  right:15px;" data-uk-tooltip="{pos:'left'}" title="Confirmar lançamento" data-cached-title="Confirmar lançamento" ><i class="uk-icon-check"></i> Confirmar </a>
