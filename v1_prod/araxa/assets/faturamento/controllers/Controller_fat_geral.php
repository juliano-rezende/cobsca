...
echo'<div class="tabs-spacer" style="display:none;">';
$Query_confirm=faturamentos::find_by_sql("SELECT id FROM faturamentos WHERE referencia='".$referencia."' AND matricula='".$matricula."' AND ( status='0' or status='1' )");
echo'</div>';
...
echo'<div class="tabs-spacer" style="display:none;">';
$Query_confirm=faturamentos::find_by_matricula_and_referencia($matricula,$referencia);
echo'</div>';
