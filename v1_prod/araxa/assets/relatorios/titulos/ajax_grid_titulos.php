...
<div style="height:<?php echo tool::HeightContent($COB_Heigth)-75;?>px; overflow:hidden; margin-bottom: 15px; ">
...
<span style="float: left; margin: 7px;" class="uk-text-small"><?php echo "Total de Registros ".$items.""; ?></span>
 <ul class="uk-pagination" style="position:relative; margin:3px 0;" data-uk-pagination="{edges:4,items:<?php echo $items; ?>, itemsOnPage:50, currentPage:<?php echo $pagina;?>}"></ul>
