...
$FRM_pesquisapor    = isset( $_POST['tdp']);
...
FROM med_autorizacoes WHERE med_autorizacoes.dt_inclusao BETWEEN '".tool::InvertDateTime(tool::LimpaString($FRM_dt_inicial),0)."' AND '".tool::InvertDateTime(tool::LimpaString($FRM_dt_final),0)."'");
