...
$FRM_convenio_id    = isset( $_GET['convenios_id'])  ? $_GET['convenios_id']
                                                     : tool::msg_erros("O Campo convenios_id é Obrigatorio.");
...
$FRM_subconvenio    = isset( $_GET['sub_conv'])   ? $_GET['sub_conv']            
                                                      : tool::msg_erros("O Campo subconvenio é Obrigatorio.");
...
$Query_associados=associados::find_by_sql("SELECT
                                           ...
                                           WHERE ".$status." ". $dt." ".$convenio_id." ".$subconvenio." ORDER BY associados.".$FRM_order_by."");
