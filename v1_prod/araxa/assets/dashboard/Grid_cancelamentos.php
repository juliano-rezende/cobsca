...
$Query_fat="SELECT SQL_CACHE count(matricula)  as rjan,
(SELECT count(matricula) FROM associados WHERE dt_cancelamento between '".$A."-02-01' AND '".$A."-02-29' AND status='0' AND empresas_id='".$COB_Empresa_Id."') as rfev,
(SELECT count(matricula) FROM associados WHERE dt_cancelamento between '".$A."-03-01' AND '".$A."-03-31' AND status='0' AND empresas_id='".$COB_Empresa_Id."') as rmar,
(SELECT count(matricula) FROM associados WHERE dt_cancelamento between '".$A."-04-01' AND '".$A."-04-31' AND status='0' AND empresas_id='".$COB_Empresa_Id."') as rabr,
(SELECT count(matricula) FROM associados WHERE dt_cancelamento between '".$A."-05-01' AND '".$A."-05-31' AND status='0' AND empresas_id='".$COB_Empresa_Id."') as rmai,
(SELECT count(matricula) FROM associados WHERE dt_cancelamento between '".$A."-06-01' AND '".$A."-06-31' AND status='0' AND empresas_id='".$COB_Empresa_Id."') as rjun,
(SELECT count(matricula) FROM associados WHERE dt_cancelamento between '".$A."-07-01' AND '".$A."-07-31' AND status='0' AND empresas_id='".$COB_Empresa_Id."') as rjul,
(SELECT count(matricula) FROM associados WHERE dt_cancelamento between '".$A."-08-01' AND '".$A."-08-31' AND status='0' AND empresas_id='".$COB_Empresa_Id."') as rago,
(SELECT count(matricula) FROM associados WHERE dt_cancelamento between '".$A."-09-01' AND '".$A."-09-31' AND status='0' AND empresas_id='".$COB_Empresa_Id."') as rset,
(SELECT count(matricula) FROM associados WHERE dt_cancelamento between '".$A."-10-01' AND '".$A."-10-31' AND status='0' AND empresas_id='".$COB_Empresa_Id."') as rout,
(SELECT count(matricula) FROM associados WHERE dt_cancelamento between '".$A."-11-01' AND '".$A."-11-31' AND status='0' AND empresas_id='".$COB_Empresa_Id."') as rnov,
(SELECT count(matricula) FROM associados WHERE dt_cancelamento between '".$A."-12-01' AND '".$A."-12-31' AND status='0' AND empresas_id='".$COB_Empresa_Id."') as rdez
FROM associados WHERE dt_cancelamento between '".($A)."-01-01' AND '".($A)."-01-31' AND status='0' AND empresas_id='".$COB_Empresa_Id."'";
...
?>
		...
		<div class="uk-modal-header"> <i class="uk-icon-table" ></i> Visão Geral de Contratos Cancelados.</div>
        ...
        <div class="uk-modal-footer uk-text-right">
            <a href="JavaScript:void(0);" id="Btn_Rec_prev" class="uk-button uk-button-danger" uk-data-year="<?php echo $A-1; ?>" style="right:200px; position: absolute;">
            ...
            <a href="JavaScript:void(0);" id="Btn_Rec_next" class="uk-button uk-button-danger" uk-data-year="<?php echo $A+1; ?>">Proximo <i class="uk-icon-angle-double-right" ></i></a>
		</div>
...
jQuery(".uk-grid-det a").click(function(event) {
        ...
        jQuery(".uk-modal-det").html('<i class="uk-icon-spinner uk-icon-spin"></i><span > Carregando </span>').load("assets/dashboard/Grid_ajax_cancelamentos.php?ref="+ref+"");
