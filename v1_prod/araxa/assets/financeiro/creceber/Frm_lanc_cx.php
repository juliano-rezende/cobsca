...
<input name="keyword" autocomplete="off" type="text" class=" left w_400" id="keyword" value=" <?php if(isset($Query_creceber)){if($Query_creceber[0]->tipo == 1){  echo utf8_encode($Query_creceber[0]->nm_cliente);}else{ echo utf8_encode($Query_creceber[0]->nm_fantasia);}}
?>" />
<input name="clientes_fornecedores_id_cx" id="clientes_fornecedores_id_cx" type="text" class="uk-hidden w_50"  value="<?php  if(isset($Query_creceber)){echo $Query_creceber[0]->clientes_fornecedores_id ; }?>"  />
<input name="creceber_id_cx" id="creceber_id_cx" type="text" class="uk-hidden w_50 " value="<?php if(isset($Query_creceber)){ echo $creceber_id; }?>" readonly="readonly" />
</label>
...
<select name="formas_recebimentos_id_cx" id="formas_recebimentos_id_cx" class="w_400">
...
<label>
<span>Linha Dig</span>
<input name="linha_dig_cx" id="linha_dig_cx" type="text" class="uk-text-center w_400" value="<?php if(isset($Query_creceber)){ echo $Query_creceber[0]->linha_dig; }?>" placeholder="99999.99999.99999.999999 99999.999999 9 99999999999999"/>
</label>

<label>
<span>Historico</span>
<input name="historico_cx" autocomplete="off" type="text" class=" left w_400" id="historico_cx" value="<?php if(isset($Query_creceber)){ echo $Query_creceber[0]->historico; }?>"  />
</label>

<label>
<span>Detalhes</span>
<textarea name="obs_cx" class="w_400" style="height:120px;" id="obs_cx"><?php if(isset($Query_creceber)){ echo $Query_creceber[0]->obs; }?></textarea>
</label>
...
<div style="border-bottom: 1px solid #ccc; padding-top:5px;padding-bottom:5px;">
	...
	<label>
	<span>Num Doc</span>
	<input name="num_doc_cx"  id="num_doc_cx" type="text" class="uk-text-center w_100" value="<?php  if(isset($Query_creceber)){ echo $Query_creceber[0]->num_doc; }  ?>"  readonly="readonly"/>
	</label>

	 <label>
	    <span>Parcela</span>
	    <input type="text" id="parcela_cx"  name="parcela_cx"  value="<?php  if(isset($Query_creceber)){ echo $Query_creceber[0]->n_parcela; }  ?>""  class="uk-text-center w_100 " readonly="readonly">
	    </label>
	<label>
...
<input name="dt_vencimento_cx" id="dt_vencimento_cx" type="text" class="uk-text-center w_100" placeholder="00/00/0000" value="<?php
	...
	<input name="dt_recebimento_cx" id="dt_recebimento_cx" type="text" class="uk-text-center w_100" placeholder="00/00/0000"  data-uk-datepicker="{format:'DD/MM/YYYY'}" />
	</label>
...
<label>
<span>Valor</span>
<input name="vlr_nominal_cx" id="vlr_nominal_cx" type="text" class="uk-text-center w_100 " placeholder="0,00" value="<?php  if(isset($Query_creceber)){echo number_format($Query_creceber[0]->vlr_nominal,2,",","."); }?>"  />
</label>
...
<input name="vlr_total_cx" type="text" class="uk-text-center w_100 uk-text-danger" id="vlr_total_cx" readonly="readonly" value="<?php  if(isset($Query_creceber)){echo number_format($Query_creceber[0]->vlr_nominal,2,",","."); }?>" />
</label>
