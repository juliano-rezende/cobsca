...
$Query_all=associados::find_by_sql("SELECT associados.*,convenios.nm_fantasia FROM associados
                                    ...
                                    WHERE associados.dt_cadastro between '".$FRM_referencia."-01' AND '".$FRM_referencia."-31' AND associados.status='1' AND associados.empresas_id='".$COB_Empresa_Id."'");
...
?>
    ...
    <div class="uk-modal-header">
      <a href="JavaScript:void(0);" id="Btn_Det_New_cad_voltar" class="uk-button uk-button-primary" uk-data-year="<?php echo $year[0]; ?>"><i class="uk-icon-angle-double-left" ></i> Voltar</a>
    </div>
...
<table  class="uk-table" >
    <thead >
      <tr style="line-height:25px;">
        ...
        <th class="uk-width uk-text-center" style="width:100px;" >Dt Cad</th>
...
$linha++;
$dt_cad  = new ActiveRecord\DateTime($List_detalhes->current()->dt_cadastro);
