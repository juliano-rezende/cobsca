...
// cartão de credito
$FRM_numero_cc			=	isset( $_POST['numero_cc'])					? $_POST['numero_cc']				:	tool::msg_erros("Campo Obrigatorio 12 faltando");
$FRM_validade_cc		=	isset( $_POST['validade_cc'])				? $_POST['validade_cc']				:	tool::msg_erros("Campo Obrigatorio 13 faltando");
$FRM_cod_seg_cc			=	isset( $_POST['cod_seg_cc'])				? $_POST['cod_seg_cc']				:	tool::msg_erros("Campo Obrigatorio 14 faltando");
$FRM_associados_card_id =  isset($_POST['associados_card_id'])          ? $_POST['associados_card_id']      :   "";
//debito em conta
