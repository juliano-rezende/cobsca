    ...
    <fieldset style="width:350px; background-color:transparent;padding-top:0;margin:0;">
        ...
        <label> <span>Forma Receb</span> <select name="f_receb" id="f_receb" class="select w_150">
            ...
            <div class="uk-form-icon">
                ...
                <input name="descontos" <?php if ($COB_Acesso_Id < 3) {  echo "readonly"; } else { echo 'onkeyup="if ((window.event ? event.keyCode : event.which) == 13) { Calcular(); }" onblur ="Calcular();"'; } ?> type="text" class=" w_150 uk-text-center " id="descontos" value="0,00" />
...
<script type="text/javascript">
    ...
    jQuery("#f_receb").change(function() {
        ...
        if (str[2] == "002" || str[2] == "003" || str[2] == "004") {
            ...
            jQuery("#label_doc_cartao").show();
            //var vlrcob= jQuery("#ttpg").val();

            //New_window('file-text-o','600','260','Pagamento com Cartão','assets/faturamento/Frm_pay_card_api.php?mat=<?=$FRM_matricula; ?>&vlrcob='+vlrcob+'',true,false,'Carregando...');
