...
// Código Original da Remessa Obs.:  Esse campo terá conteúdo diferente de 0(zeros) caso ocorra erro no processamento da remessa - Nota 5 codigo da tebala de rejeiçao
$d_cod_original_remessa  = ltrim(substr($linha,135,2), "0");
...
continue;
  ...
  $debito     += $d_v_tarifa_custas;         /* total da tarifa paga pelo titulo */
...
echo '<div class="uk-alert" style="margin:2px;"> Arquivo Processado com sucesso ( '.$registros.' ) titulos processados.</div>';
...
$arquivo=$caminho."/".$filename_log;
    ...
    if($baixados > 0){ echo "<div class='uk-alert uk-alert-warning' style='margin:2px;'> Titulos baixados ".$baixados."</div></br>"; }
    if($cancelados > 0){ echo "<div class='uk-alert uk-alert-warning' style='margin:2px;'> Titulos baixados pelo banco  ".$cancelados."</div></br>"; }
    if($compensados > 0){ echo "<div class='uk-alert uk-alert-success' style='margin:02px;'> Titulos Compensados ".$compensados."</div></br>"; }
  ...
  if($baixados > 0){ echo "<div class='uk-alert uk-alert-warning' style='margin:2px;'> Titulos baixados ".$baixados."</div></br>";}
  if($cancelados > 0){ echo "<div class='uk-alert uk-alert-warning' style='margin:2px;'> Titulos baixados pelo banco  ".$cancelados."</div></br>"; }
  if($compensados > 0){ echo "<div class='uk-alert uk-alert-success' style='margin:2px;'> Titulos Compensados ".$compensados."</div></br>";}
