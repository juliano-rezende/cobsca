 ...
 */
define("DB_USER", 'u100549133_demo');
define("DB_PASSWORD", 'z*LgZR^5h23');
define("DB_NAME", 'u100549133_demo');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", './gzip_files/'); // Comment this line to use same script's directory ('.')
