...
class paymentAddCard
{
    ...
    public function AddCard($matricula, $holder_name, $expiration_month, $expiration_year, $card_number, $security_code, $apicobclienteid)
    {
        ...
        $cobClienteId = $apicobclienteid ? $apicobclienteid : 0;
        ...
        $this->apicobclienteid = self::cleanNumbers("$cobClienteId");
        $this->apicobcardid = 0;

        if(strlen($this->expiration_year) == 2){
            $this->expiration_year = "20".$this->expiration_year;
        }
