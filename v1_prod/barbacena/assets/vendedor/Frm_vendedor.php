...
<fieldset style="width:870px;">
    ...
    <label>
        <span>Tx Adesão</span>
        <input value="<?php if(isset($dadosvendedor)):echo number_format($dadosvendedor[0]->tx_adesao,2,",",","); endif; ?>" type="text" class="uk-text-left w_100" name="tx_adesao" id="tx_adesao"/>
        <div class="uk-badge uk-badge-warning">Alocar o valor que será repassado para o vendedor</div>
    </label>
	<label>
