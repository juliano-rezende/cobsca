...
#FrmNovFormCob  span{  width:200px;  }
#FrmNovoPlano span {  width:200px;  }
</style>
...
<nav class="uk-navbar  uk-text-center" style="line-height: 30px; ">
     <table  class="uk-table" >
      <thead >
        <tr><th colspan="7" class="uk-text-center" style="line-height: 20px;">Planos Disponíveis</th></tr>
        <tr style="line-height: 20px;">
            <th class="uk-width uk-text-left" style="width:20px;"></th>
            <th class="uk-width  uk-text-center" style="width:100px;"  >Status</th>
            <th class="uk-width  uk-text-center" style="width:100px;" >Codigo</th>
...
<div id="GridPlanos" style="height:235px; overflow-y:scroll;">


</div>

<form class="uk-form uk-form-tab" id="FrmNovFormCob" style="padding: 0; margin: 0;">
    <div id="DadosNovaForma" class="uk-modal">
        <div class="uk-modal-dialog" style="width:700px;">
            ...
            <label>
               <span>Descrição</span>
               <input type="text" class="w_300" name="desc" id="desc" placeholder="DESCRIÇÃO DA FORMA DE COBRANÇA"  />
           </label>
           <label>
            <span>Forma de Cobrança</span>
            <select name="f_cob_sys" id="f_cob_sys" class="select w_300">
        ...
        <label>
            ...
            <select name="tp_cob" id="tp_cob" class="select w_300">
                <option value="" selected></option>
        ...
        <div class="uk-modal-footer uk-text-right">
            <a id="Btn_fmb_0" class="uk-button uk-button-primary" ><i class="uk-icon-check" ></i> Confirmar</a>
    ...
    <div id="DadosNovoPlano" class="uk-modal">
        <div class="uk-modal-dialog" style="width:600px;">
            ...
            <label>
                ...
                <select name="f_cob_conv" id="f_cob_conv" class="select">
                    ...
                    while($List_forma->valid()):
                        ...
                        echo'<option value="'.$List_forma->current()->id.'" >'.strtoupper(($List_forma->current()->descricao)).'</option>';
            ...
            <label>
                ...
                <select name="mod_plano" id="mod_plano" class="uk-form-select">
                    <option value="" selected></option>
            ...
            <div class="uk-modal-footer uk-text-right">
                <a id="Btn_fmb_1" class="uk-button uk-button-primary" ><i class="uk-icon-check" ></i> Confirmar</a>
                <a id="BtnCancelarFiltro" class="uk-button uk-button-danger uk-modal-close" ><i class="uk-icon-remove" ></i> Cancelar</a>
            </div>
        </div>
    </div>
...
<script type="text/javascript" >
    ...
    // descrição dos planos cadastrados
...
jQuery(function() {
    ...
    jQuery("#Btn_fmb_0").click(function(event) {
        ...
        jQuery.ajax({
            async: true,
            url: "assets/convenio/Controller_formas_cobranca.php",
            type: "post",
            data:"action=addFcob&Conv_id=<?php echo $FRM_convenio_id; ?>&"+jQuery("#FrmNovFormCob").serialize(),
            success: function(resultado){
                if(jQuery.isNumeric(resultado)){
                        ...
                        // recarrega a pagina
                        jQuery("#"+jQuery("#FrmNovFormCob").closest('.Window').attr('id')+"").remove();
                        New_window('list','900','500','Formas de Cobrança','assets/convenio/Frm_formas_cobranca.php?convenio_id='+conv_id.replace(/[^\d]+/g,'')+'',true,false,'Carregando...');
...
// inserir planos para forma de cobrança
jQuery(function() {

    jQuery("#Btn_fmb_1").click(function(event) {
        ...
        jQuery.ajax({
            ...
            url: "assets/convenio/Controller_formas_cobranca.php",
            type: "post",
            data:"action=addFpl&"+jQuery("#FrmNovoPlano").serialize(),
            success: function(resultado){
                if(jQuery.isNumeric(resultado)){
                        // mensagen de carregamento
                        jQuery("#msg_loading").html(" Carregando ");
                        // variavel com id
                        var fcob_id=resultado;
                        // recarrega a pagina
                        jQuery("#GridPlanos").load("assets/convenio/Grid_planos_fcob.php?fcob_id="+fcob_id.replace(/[^\d]+/g,'')+"",function(){modal.hide();});
