...
$status_p				= isset( $_GET['status'])				? $_GET['status']:  			tool::msg_erros("O Campo Obrigatorio 0-2 Faltando.");
...
if($status == "" ){$campo="contas_pagar.dt_vencimento";}elseif($status == 0 ){$campo="contas_pagar.dt_vencimento";}else{$campo="contas_pagar.dt_pagamento";}
...
jQuery("#Grid_contas_pagar table tbody tr").click(function(){
