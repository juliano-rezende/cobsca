<div class="uk-modal-dialog" style="width:500px;">
        ...
        <div class="uk-modal-footer uk-text-right">
            <a href="JavaScript:void(0);" id="Btn_filtro_creceber_00" class="uk-button uk-button-small uk-button-primary" ><i class="uk-icon-search" ></i> Pesquisar</a>
            <a href="JavaScript:void(0);" id="Btn_filtro_creceber_01" class="uk-button uk-button-danger uk-button-small uk-modal-close" ><i class="uk-icon-remove" ></i> Cancelar</a>
		</div>
</div>
...
/********************************************************************/
jQuery("#Btn_filtro_creceber_00").click(function (){
...
LoadContent('assets/financeiro/creceber/Grid_c_receber.php?action=search&contas_bancarias_id='+conta+'&status='+status+'&intervalo='+periodo+'&p_inicio='+inicio+'&p_fim='+fim+'','Grid_contas_receber');
