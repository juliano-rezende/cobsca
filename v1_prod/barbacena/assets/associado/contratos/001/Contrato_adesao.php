...
<div id="col_contratada" style="border:0; height: auto; width: 98%; margin: 20px auto;">
    ...
    <div class="uk-article">
        ...
        <p style="font-size: 11px; text-align: justify;"> <strong><?php echo strtoupper($dadosassociado[0]->razao_social); ?></strong> Pessoa jurídica de direito privado,devidamente inscrita no CNPJ sob o nº <strong><?php echo tool::MascaraCampos("??.???.???/????-??",$dadosassociado[0]->cnpj); ?></strong>,</ br> com sede na cidade de Barbacena/MG, na Rua General Câmara ,155 Centro CEP:36200-102, neste ato como CONTRATADA.</p>

        <p style="font-size: 11px; text-align: justify; margin: 15px 0;">Os benefícios, responsabilidades e obrigações deste contrato  reger-se-ão pelas cláusulas arroladas abaixo e por eventuais modificações estipuladas.</p>
    </div>
...
<div id="colclausulas" style="border:0; height: auto; width: 98%; margin: 0px auto;">
    ...
    <div class="uk-article">
        <h1 class="uk-article-lead" style="font-size: 11px; font-weight: bold;">CLÁUSULA PRIMEIRA – DO OBJETO</h1>
        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
...
<div id="colclausulas" style="border:0; height: auto; width: 98%; margin: 5px auto;">
    ...
    <div class="uk-article">
        <h1 class="uk-article-lead" style="font-size: 11px; font-weight: bold;">CLÁUSULA SEGUNDA – DAS OBRIGAÇÕES DA CONTRATADA</h1>
        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
    ...
    <div class="uk-article">
        ...
        <h1 class="uk-article-lead" style="font-size: 11px; font-weight: bold;">CLÁUSULA TERCEIRA – DAS OBRIGAÇÕES DO CONTRATANTE</h1>
        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
        ...
        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
            <strong>Parágrafo Segundo:</strong> A(o) CONTRATANTE efetuará no ato do Cadastro/inscrição o pagamento do valor correspondente, assumindo o compromisso de pagar as parcelas mensais e sucessivas que eventualmente sejam acordadas entre as partes e na data estipulada,  demonstrado a(o) CONTRATANTE, no ato da efetivação da Cadastro/inscrição, exposto neste contrato.
        </p>

        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
            <strong>Parágrafo Terceiro:</strong> O pagamento das parcelas ora avençado deverá ser efetuado conforme indicado pela CONTRATADA e a seu exclusivo critério.
        </p>
        ...
        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
            <strong>Parágrafo Quinto: </strong> O CONTRATANTE se declara ciente de que os serviços oferecidos pelo CONTRATADA, não se caracterizam como plano de saúde ou seguro de saúde nos moldes da lei 9656/1998.
        </p>
    </div>
    <div class="uk-article">
        <h1 class="uk-article-lead" style="font-size: 11px; font-weight: bold;">CLÁUSULA QUARTA – DO INADIMPLEMENTO</h1>
        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
        ...
        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
            <strong>Parágrafo Setimo: </strong> O recebimento pela CONTRATADA de eventual parcela em atraso, sem encargos será interpretado como mera liberalidade, não desconstituindo as condições pertinentes ora avençadas.
        </p>
    ...
    <div class="uk-article">
        ...
        <h1 class="uk-article-lead" style="font-size: 11px; font-weight: bold;">CLÁUSULA QUINTA – DOS VALORES</h1>

        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
            <strong>Parágrafo Primeiro:</strong> O CONTRATANTE pagará 12 parcelas sucessivas no valor de <strong>R$ <?php echo number_format($dadosassociado[0]->valor,2,',','.'); ?></strong> ( <?php echo tool::valorPorExtenso($dadosassociado[0]->valor) ; ?>  ) totalizando o valor de <strong>R$ <?php echo number_format($dadosassociado[0]->valor*12,2,',','.'); ?></strong> ( <?php echo tool::valorPorExtenso($dadosassociado[0]->valor*12) ; ?>),   ou avista no valor de <strong>R$<?php echo  number_format($dadosassociado[0]->valor*11,2,',','.'); ?>
    ...
    <div class="uk-article">
        ...
        <h1 class="uk-article-lead" style="font-size: 11px; font-weight: bold;">CLÁUSULA SEXTA – DA VIGÊNCIA</h1>
        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
...
<div id="colclausulas" style="border:0; height:1000px; width: 98%; margin: 5px auto;">
    ...
    <div class="uk-article">
        ...
        <h1 class="uk-article-lead" style="font-size: 11px; font-weight: bold;">CLÁUSULA SÉTIMA – DA RESCISÃO</h1>
        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
        ...
        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
            <strong>Parágrafo Segundo:</strong> As partes poderão rescindir o presente contrato unilateralmente sem qualquer ónus, desde que tenha transcorrido um mínimo de 6 (seis) meses do contrato, através de comunicado escrito com antecedência de 30 (trinta) dias. Em caso contrario o TITULAR pagará; uma multa de 50% das parcelas restantes para o termino da vigência do contrato.
        </p>

        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
            <strong>Parágrafo Terceiro:</strong>  O cancelamento do contrato só se dará se o mesmo for feito de forma pessoal com a assinatura de um termo de cancelamento não sendo possível o cancelamento por telefone, mensagens, e-mails ou algo do gênero.
        </p>
    </div>
    <div class="uk-article">

        <h1 class="uk-article-lead" style="font-size: 11px; font-weight: bold;">CLÁUSULA OITAVA – DO FORO</h1>
        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
            <strong>Parágrafo único:</strong> Fica eleito o Foro da Comarca de Barbacena, para dirimir eventuais dúvidas decorrentes deste contrato, com exclusão de qualquer outro, por mais privilegiado que seja.
        </p>
    </div>
    <div class="uk-article" style="margin-top: 20px; border: 1px solid #f5f5f5;">
        ...
        <div style="float:left;">
            ...
            <h1 class="uk-article-lead" style="font-size: 11px; font-weight: bold;">DETALHES DA COBRANÇA</h1>
