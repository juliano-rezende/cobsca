...
<!--                    <li data-uk-tooltip="" title="" data-cached-title="Tela Inicial">
 ...
 -->
        ...
        <li data-uk-tooltip="" title="" data-cached-title="Baixar boletos" id="Sup_Btn_003">
            <a   style="border-bottom-color:#0CC;" >
                <i class="uk-icon-barcode"></i> Baixar boletos
            </a>
        </li>
    </ul>
    <div class="uk-navbar-flip" style="color: #fff; width:200px; display: none;">
    ...
    <div class="uk-navbar-flip" style="color: #fff; padding:10px; margin-right:10px;float: right; border-left: 1px solid #f5f5f5; ">
        <i class="uk-icon-user"></i> Usúario logado: <?php echo $COB_username;?>
    </div>
