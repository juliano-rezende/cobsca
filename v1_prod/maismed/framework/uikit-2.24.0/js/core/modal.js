...
(function(UI) {
    ...
    UI.modal.prompt = function(text,typec, value, onsubmit, options) {
        ...
        var modal = UI.modal.dialog(([
            ...
            '<div class="uk-margin-small-top uk-modal-content uk-form"><p><input type="'+typec+'" class="uk-width-1-1"></p></div>',
        ...
        input = modal.element.find("input[type='"+typec+"']").val(value || '').on('keyup', function(e){
            if (e.keyCode == 13) {
