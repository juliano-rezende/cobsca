...
// cartão de credito
    ...
    if ($Query_dados_cobranca[0] -> api_cob_cliente_id == "") {
        ...
        if (
            ...
            $json = '":"","failCad":"true","message":"Transação não realizada. Endereço incompleto, favor completar o cadastro';
            echo $json;
            die();
        }
        ...
        if ($resultSendCreateBuyer -> error == "true") {
            ...
            $json = '":"","failCad":"true","message":"Erro ao cadastrar cliente na base cobApi. Contate o suporte. Erro de retorno:' . $resultSendCreateBuyer -> message;
            echo $json;
            die();
            ...
            if ($resultSendAddCard -> error == "true") {
                ...
                $json = '":"","failCad":"true","message":"Erro ao adcionar cartão de credito na base cobApi. Contate o suporte. Erro de retorno:' . $resultSendAddCard -> message;
                echo $json;
                die();
        ...
        if ($resultSendAddCard -> error == "true") {
            ...
            $json = '":"","failCad":"true","message":"Erro ao adcionar cartão de credito na base cobApi.[br]Contate o suporte![br]Erro cobApi:' . $resultSendAddCard -> message;
            echo $json;
            die();
