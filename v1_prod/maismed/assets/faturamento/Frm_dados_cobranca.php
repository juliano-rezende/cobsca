    ...
    <fieldset style="width:450px;">
        ...
        <label>
            ...
            <select class="select" name="formadecobranca" id="formadecobranca">
                <option selected="selected"  value="" >Selecionar
                <?php
                if ($Query_dados) {
        ...
        <label>
            ...
            <select class="select" name="dt_venc_p" id="dt_venc_p">
                ...
                <?php }elseif ($Query_dados[0]->dt_venc_p == 20){ ?>

                <option value="">Selecionar
                <option value="10">dia 10
                <option value="15">dia 15
                <option value="20" selected="selected">dia 20
...
<a id="Btn_confirm_cob" class="uk-button uk-button-primary " style="position:absolute;; right:15px; bottom:30px; z-index:2;" data-uk-tooltip="{pos:'left'}" title="Confirmar dados"
   data-cached-title="Confirmar dados"><i class="uk-icon-check"></i> Confirmar</a>
