    ...
    <div id="Geral" class="tab-content">
        ...
        <label>
            ...
            <input type="text" class="uk-text-right w_120" style="background-color: #fff; color: #000;"
                   ...
                   id="dtv"
                <?php if ($Query_fat[0]->titulos_bancarios_id > 1) { ?> disabled="disabled" <?php } ?>
        ...
        <label>
            <span>Valor</span>
            <input type="text" style=" background-color: #fff; color: #000;" <?php if ($Query_fat[0]->titulos_bancarios_id > 1) {
        ...
        <label>
            ...
            <textarea  <?php if ($Query_fat[0]->titulos_bancarios_id > 1) {
                echo 'disabled="disabled"';
