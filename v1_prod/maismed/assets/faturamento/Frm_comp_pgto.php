...
<nav class="uk-navbar" style="padding:8px 18px 8px 0px; text-align: right;">
								...
								<a  id="Btn_dow"><i class="uk-icon-floppy-o uk-icon-medium "></i></a>
								<a  id="Btn_email"><i class="uk-icon-envelope-o uk-icon-medium "></i></a>
</nav>



<div style="height: 360px; width:100%; overflow-y: scroll;" id="print_comp_pgto">
