...
<nav class="uk-navbar" style="padding:8px 18px 8px 0px; text-align: right;">
	<a class="btn" onclick="CarneVeiwPdf('<?php echo $FRM_parcelas_id; ?>');"><i class="uk-icon-file-pdf-o uk-icon-medium
"></i> Imprimir Carnê </a>
...
echo'<div id="print_c" style=" height:505px;width:100%; overflow:auto; padding:0; margin:0 auto;background:#fff; ">';
	...
	$bol++;// conta os boletos
		...
		echo'<div style="width:870px; height:350px; padding:0; padding-bottom:8px; margin:-2px auto; border:0px solid #ccc;background:#fff;" >';
...
<div id="Col_pdf_email" class="uk-modal">
    <div class="uk-modal-dialog" style="width:500px;">
        ...
        <h2><i class="uk-icon-envelope-o" ></i> Carnê por e-mail</h2>
        </div>
