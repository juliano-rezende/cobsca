<div class="uk-modal-dialog" style="width:500px;">
		...
		<h2><i class="uk-icon-filter uk-icon-small" ></i> Filtro</h2>
                ...
                <div class="uk-form-icon">
                <i class="uk-icon-calendar"></i>
                <input name="dtfim" value="<?php echo date("t/m/Y"); ?>" type="text" class="input_text w_100 center periodo" id="dtfim" data-uk-datepicker="{format:'DD/MM/YYYY'}"   />
                </div>
                </label>
        ...
        <div class="uk-modal-footer uk-text-right">
            ...
            <a href="JavaScript:void(0);" id="Btn_tt_03" class="uk-button uk-button-primary uk-button-small" ><i class="uk-icon-print" ></i> Imprimir</a>
...
jQuery("#Btn_tt_03").click(function (){
window.open("assets/relatorios/associados/associados_print.php?"+jQuery("#FrmFiltroAssociados").serialize()+"");
});
</script>