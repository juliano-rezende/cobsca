...
$empresa=empresa::find_by_cdempresa(1);
$seg_empresa=seg_emp::find_by_cdempresa(1);
...
$query=arq_seguradora::find_by_sql("Select * From tbarq_seguradora Where MONTH(datacriacao) = MONTH(CURDATE())");
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
$mail->AddAttachment("../../Plan_enviadas/empresa_1/".$list->current()->arquivo."", "".$list->current()->arquivo."");  // Insere um anexo
...
$update=arq_seguradora::find_by_cdregistro($list->current()->cdregistro);
