...
<div class="tabs-spacer" style="display:none;">
  ...
  $query="SELECT
  faturamentos.*,associados.nm_associado,associados.fone_cel,associados.fone_fixo,associados.convenios_id AS cdconv,
      ...
      while($Listitles->valid()):
        ...
        <tr style="line-height:22px;" class="<?php echo $class; ?>">
          ...
          <td class="uk-width uk-text-center" style="width:90px;"><?php echo $Listitles->current()->matricula; ?> </th>
            ...
            <td class="uk-width uk-text-center" style="width:100px;" ><?php echo $Listitles->current()->fone_cel; ?></td>
            <td class="uk-width uk-text-center " style="width:100px;" ><?php echo $Listitles->current()->fone_fixo; ?></td>
            <td class="uk-width uk-text-center" style="width:100px;" ><?php echo number_format($Listitles->current()->total_amount_ab,2,",","."); ?></td>
