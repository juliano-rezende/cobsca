jQuery(document).ready(function(){
	...
	if (jQuery("#Frmcpagar").length || jQuery("#Frmcreceber").length){ jQuery("#Btn_for_0,#Btn_for_0_divider").hide()}else{jQuery("#Btn_for_0,#Btn_for_0_divider").show()}
...
jQuery("#Btn_for_0").click(function(){
	New_window('search','980','500','Pesquisa Fornecedor','assets/fornecedor/Frm_pesquisa_fornecedores.php',true,false,'Carregando...');
});


//Abre uma janela para adcionar cliente
jQuery("#Btn_for_1").click(function(){
...
jQuery(function() {
	...
	jQuery("#Btn_for_2").click(function(event) {
		 ...
		 jQuery.ajax({
						async: true,
						url: "assets/fornecedor/Controller_fornecedores.php",
						type: "post",
						data:jQuery("#FrmFornecedor").serialize(),
						success: function(resultado) {
														if(jQuery.isNumeric(resultado)){
															if (jQuery("#Frmcpagar").length || jQuery("#Frmcreceber").length){
																		...
																		/**/
																        jQuery("#"+jQuery("#FrmFornecedor").closest('.Window').attr('id')+"").remove();
																		...
																		// variavel com id
																		var for_id=resultado;
																		// recarrega a pagina
																		LoadContent('assets/fornecedor/Frm_fornecedor.php?for_id='+for_id.replace(/[^\d]+/g,'')+'','content');
																	}
