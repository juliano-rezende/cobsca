...
<?php if(isset($dadosempresa)):?>
    ...
    <a  href="../maismed/assets/arquivos/contrato_empresarial.pdf" target="_blank" class="uk-icon-button uk-icon-file-pdf-o" style="margin-top:2px;" data-uk-tooltip="{pos:'left'}" title="Contrato Empresial" data-cached-title="Contrato Empresarial"></a>
