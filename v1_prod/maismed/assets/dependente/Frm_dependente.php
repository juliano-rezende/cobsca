...
<form method="post" id="Frmdependente" class="uk-form" style="margin-top: 0">
...
<a id="Btn_dep_1" class="uk-button uk-button-primary" style="right: 10px; margin-right:5px; width: 120px;bottom:30px; position:absolute; z-index: 2;" data-uk-tooltip="{pos:'left'}"
   title="Salvar Alterações" data-cached-title="Salvar Alterações"><i class="uk-icon-pencil "></i> Salvar</a>

<a id="Btn_dep_2" class="uk-button uk-button-primary" style=" right: 10px; margin-right:5px; width: 120px;bottom:30px; position:absolute;z-index: 2;" data-uk-tooltip="{pos:'left'}"
   title="Gravar Novo " data-cached-title="Gravar Novo "><i class="uk-icon-floppy-o"></i> Gravar</i></a>
            ...
            jQuery.ajax({
                ...
                success: function (resultado) {
                    ...
                    if (obj.callback == 1) {
                        ...
                        var matricula = jQuery("#matricula").val();
                        var convenio = jQuery("#convenio").val();
                        New_window('file-text-o', '500', '260', 'Dados de Cobrança', 'assets/faturamento/Frm_dados_cobranca.php?matricula='+matricula+'&convenio_id='+convenio+'', true, false, 'Carregando dados...');
