...
<div id="menu-float" style="text-align:center;margin:0 780px; top:40px;  border:0;background-color:#546e7a; ">
    <a onclick="D_Act('new','<?php echo $FRM_matricula; ?>');" class="uk-icon-button uk-icon-user-plus" style="margin-top:2px;" data-uk-tooltip="{pos:'left'}" title="Novo Dependente"
       data-cached-title="Novo Dependente"></a>
</div>
