...
$FRM_mat    = isset( $_GET['matricula'])  ? $_GET['matricula']/* variavel com os ids das parcelas*/
...
jQuery(function(){
    ...
    jQuery("#Btn_add_hist_0").click(function(event) {
       ...
       var matricula = '<?php echo $_GET['matricula']; ?>';
        ...
        var data="action=add_historico&mat="+matricula+"&motivo="+jQuery("#motivo").val()+"&detalhes="+jQuery("#detalhes").val();
