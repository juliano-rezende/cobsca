...
<form method="post" id="FrmAssociado" class="uk-form uk-form-shadow " style="width: 900px;">
    ...
    <fieldset style="width:870px; margin-bottom: 30px !important;">
        ...
        <label>
            <span>Cod Mais Med</span>
            <input type="text" class="uk-text-center w_100" id="cod_mais_med" name="cod_mais_med" value="<?php if (isset($dadosassociado)): echo $dadosassociado[0]->cod_mais_med; endif; ?>">
        </label>
        <label>
            <span>Prontuario</span>
            <input type="text" class="uk-text-center w_100" id="prontuario_mais_med" name="prontuario_mais_med" value="<?php if (isset($dadosassociado)): echo $dadosassociado[0]->prontuario_mais_med; endif; ?>">
        </label>
        <label>
            ...
            else: echo date("d/m/Y"); endif; ?>" type="text" class=" w_100 uk-text-center" name="dt_cadastro" id="dt_cadastro" readonly="readonly">
            <?php
        ...
        <label>
            <span>Data Nasc</span>
            <input value="<?php if (isset($dadosassociado)):$now = new ActiveRecord\DateTime($dadosassociado[0]->dt_nascimento);
                echo $now->format('d/m/Y'); endif; ?>" type="text" class=" w_100 uk-text-center" name="data_nasc" id="data_nasc" placeholder="00/00/0000"/>
            <?php
            if (isset($dadosassociado)):
                $idde = tool::CalcularIdade($now->format("Y-m-d"), date("Y-m-d"));
                echo '<div class="uk-badge uk-badge-warning">( ' . $idde . ' ) Anos</div>';
        ...
        <label>
            ...
            <div class="uk-form-icon">
                ...
                <input name="cep" class="w_100 uk-text-center" id="cep" onfocus="Busca_Cep('')"
                       value="<?php if (isset($dadosassociado)):echo tool::MascaraCampos("?????-???", $dadosassociado[0]->cep); endif; ?>" maxlength="9">
            </div>
        ...
        <label>
            ...
            <button class="uk-button uk-button-small uk-button-primary" type="button" id="addUf"><i class="uk-icon-plus"></i> Adcionar</button>
        </label>
        <!-- -->
        <label>
            <span>cidade</span>
