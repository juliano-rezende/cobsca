      ...
      <tr>
        <td style="border:0; padding:0;"><table  width="100%" border="0" cellspacing="0" cellpadding="0" style="border:0;">
          <tr >
            ...
            <td width="30%" class="titulo">Convênio</td>
          </tr>
          <tr >
...
<div id="colclausulas" style="border:0; height: auto; width: 98%; margin: 0px auto;">
      ...
      <div class="uk-article">
        ...
        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
        2) É obrigatória(Se entregue ao associado), a devolução das carterinhas de identificação se concedidas aos inscritos no convênio, no prazo máximo de 10 dias.
        </p>

        <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
        3) O CONTRATANTE é plenamente responsável pelo pagamento integral de dispesas que resultem no uso indevido, por parte dele próprio ou de seus dependentes após a,formalização deste pedido.
        </p>
