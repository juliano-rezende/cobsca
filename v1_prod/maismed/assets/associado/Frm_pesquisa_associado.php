...
<nav class="uk-navbar uk-gradient-cinza">
    <div class="uk-navbar-content uk-hidden-small uk-form">
        <input type="search" id="vl" autocomplete="off" class="uk-width" style="width:600px;" placeholder="CODIGO | MATRICULA | NOME | DATA NASCIMENTO | CPF | NOME DEPENDENTE" onkeyup="if ((window.event ? event.keyCode : event.which) == 13) { BuscaAssociado(); }">
