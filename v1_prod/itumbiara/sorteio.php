        ...
        <div class="uk-width-medium-1-1 uk-row-first">
            ...
            <div class="uk-vertical-align uk-text-center uk-margin-top">
                <div class="uk-vertical-align-middle">
                    <a class="uk-button uk-button-large uk-button-success" data-action="start" href="#">Iniciar</a>
                    <a class="uk-button uk-button-large uk-button-primary" data-action="stop" href="#">Parar</a>
