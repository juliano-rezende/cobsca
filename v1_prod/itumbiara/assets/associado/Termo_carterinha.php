...
$dadosdependentes = dependentes::find_by_sql("SELECT
                                           ...
                                           WHERE dependentes.matricula='" . $FRM_matricula . "' AND carteirinha = 1");
...
<div id="print_c" style=" height: 505px; width:100%; overflow:auto; padding:0; margin:0 auto;background:#fff; ">
    ...
    <div id="big_col_contrato" style="border:0; width: 98%; margin: 0 auto;">
        <div id="col_left_header" style="float: left; height:80px; width: 20%; ">
            <div id="col_logo" style=" float: left; margin: 0;">
                <img src="imagens/empresas/<?php echo $dadosassociado[0]->logomarca; ?>.png" width="150" height="100">
            </div>
        </div>
        <div id="col_center_header" style="float: left; height:80px; width: 70%; text-align: center; padding-top: 10px; padding-left: 15px;">
            <div class="uk-article" style="padding-left: 25px">
                <p style="font-size: 9pt; text-align: justify; margin-bottom: 5px; font-size: 16pt; font-weight: bold; padding-left: 30px">
                    TERMO SOLICITAÇÃO DE CARTÃO
                </p>
                <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px; padding-left: 100px;">
                ...
                <td style="border:0;padding:0;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:0;">
                        ...
                        <tr>
                            ...
                            <td align="center"><?php $dnasc = new ActiveRecord\DateTime($dadosassociado[0]->dt_nascimento);
                                echo $dnasc->format("d/m/Y"); ?></td>
                ...
                <td style="border:0;padding:0;">
                    <table style="border:0;" width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td align="center"><?php if ($dadosassociado[0]->casa_propria == "s") {
                                    echo "Sim";
                                } elseif ($dadosassociado[0]->casa_propria == "n") {
                                    echo "Não";
                                } else {
                                    echo "-";
                                } ?></td>
    ...
    <div id="col_contratada" style="border:0; height: auto; width: 98%; margin: 20px auto;">
        ...
        <div class="uk-article">
            ...
            <p style="font-size: 9pt; text-align: justify;">
                Como CONTRATANTE dos beneficios acima identificado, solicito a carteirinha para meus dependentes conforme descritos e relacionados abaixo:
            </p>
        </div>
                ...
                <td style="border:0; padding:0;">
                    <table style="border:0;" width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr class="titulo">
                            ...
                            <td width="100" align="center">Carteirinha</td>
                        </tr>
                    </table>
                </td>
            </tr>
                            ...
                            while ($list->valid()):
                                ...
                                <tr class="linhas">
                                    ...
                                    <td width="100" align="center"><?php $dtn = new ActiveRecord\DateTime($list->current()->dt_nascimento);
                                        if ($list->current()->dt_nascimento == '') {
                                            echo '00/00/0000';
                                        } else {
                                            echo $dtn->format('d/m/Y');
                                        }
                                        ?>
                                    </td>
                                    ...
                                    <td width="100" align="center" style="font-weight: bold">
                                        <?php
                                        if($list->current()->carteirinha == 1){echo "SIM";}else{echo "NÃO";}
                                        ?>
                                    </td>
                                </tr>
                                <?php
    ...
    <div id="colclausulas" style="border:0; height: auto; width: 98%; margin: 0px auto;">
        ...
        <div class="uk-article">
            <h1 class="uk-article-lead" style="font-size: 9pt; font-weight: bold;">TERMO RECEBIMENTO CARTÃO</h1>
            <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
                1) Do valor: Ficou acordado o valor de 5,00 (cinco reais) por unidade, ou seja, por pessoa. No ato da entrega do Cartão Líder +.
            </p>
            <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
                2) Das obrigações: A contratante, para cancelar o contrato com a Líder Saúde, terá a obrigação de devolver todos os cartões, sendo do titular e dos dependentes.
            </p>
            <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
                3) Assino presente termo, afirmando o recebimento de todos os cartões, e dando ciência das minhas responsabilidades.
            </p>
            <p style="font-size: 8pt; text-align: justify; margin-bottom: 5px;">
                Portanto, na condição de contratante, autorizo a emissão e entrega do mencionado cartão, assim, como cobrança do valor ora mencionado.
            </p>
        </div>

        <div class="uk-article" style="margin-top: 50px; border: 0px solid #f5f5f5;">
