...
// recupera os dados do associado
    $dadosassociado = associados::find_by_sql("SELECT
                                          ...
                                          empresas.cnpj,
                                         (select count(id) from protestos p  where p.matricula = associados.matricula and p.status=0)  as t_prot,
                                         (select count(id) from faturamentos  f  where f.matricula = associados.matricula AND f.status=0)  as t_fat       
										FROM
										  associados
...
// VALIDA A REFERENCIA DO MES ATUAL DO SEGURO
    ...
    if ($dadosassociado[0]->t_prot >= 1) {
        $protesto = '<div class="uk-badge uk-badge-danger">Enviado para cobrança.</div>';
...
<form method="post" id="FrmAssociado" class="uk-form uk-form-shadow " style="width: 900px;">
    <div id="menu-float" style="text-align:center;margin:0 900px;">
        ...
        <?php if (isset($dadosassociado)) { ?>
            ...
            <a id="Btn_assoc_3" class="uk-icon-button uk-icon-table" style="margin-top:2px;" data-uk-tooltip="{pos:'left'}" title="Faturamento Associado"
               data-cached-title="Faturamento Associado"> </a>
            ...
            <?php if ($dadosassociado[0]->t_fat > 50 && $dadosassociado[0]->t_prot == 0) { ?>
                <a id="Btn_assoc_13" class="uk-icon-button uk-icon-archive" style="margin-top:2px;" data-uk-tooltip="{pos:'left'}" title="Enviar para cobrança"
                   data-cached-title="Enviar para cobrança"> </a>
            ...
            <?php if ($dadosassociado[0]->status == 1) { ?>
                <a id="Btn_assoc_14" class="uk-icon-button uk-icon-file-text-o" style="margin-top:2px;" data-uk-tooltip="{pos:'left'}" title="Termo de Carteirinhas"
                   data-cached-title="Termo de Carteirinhas"></a>
                <a id="Btn_assoc_6" class="uk-icon-button uk-icon-file-pdf-o" style="margin-top:2px;" data-uk-tooltip="{pos:'left'}" title="Contrato de Adesão"
                   data-cached-title="Contrato de Adesão"></a>
            ...
            <?php } else { ?>
                ...
                <a id="Btn_assoc_7" class="uk-icon-button uk-icon-file-text-o" style="margin-top:2px;" data-uk-tooltip="{pos:'left'}" title="Termo de cancelamento"
                   data-cached-title="Termo de Cancelamento"></a>
            ...
            <a id="Btn_assoc_9" class="uk-icon-button  uk-icon-pencil " style="margin-top:2px; text-align:center;" data-uk-tooltip="{pos:'left'}" title="Salvar Alterações"
               data-cached-title="Salvar Alterações"> </a>
        <?php } else { ?>
            <a id="Btn_assoc_9" class="uk-icon-button  uk-icon-floppy-o" style="margin-top:2px;text-align:center;" data-uk-tooltip="{pos:'left'}" title="Gravar Novo"
               data-cached-title="Gravar Novo"></a>
        <?php } ?>
    ...
    <fieldset style="width:870px;">
        ...
        <?php if (isset($dadosassociado)) { ?>
            ...
            <div style="width: 70px; height: 31px; float: right; background-color:transparent; margin-top: -44px;">
                ...
                <a href="javascript:void(0)" style="float: left; color: #fff; font-weight: bold;" onclick="PrevNext('<?php echo $mat["prev"]; ?>');"><i class="uk-icon-angle-double-left uk-icon-large"
                                                                                                                                                        data-uk-tooltip="{pos:'left'}" title="Anterior"
                                                                                                                                                        data-cached-title="Anterior"></i> </a>
                <a href="javascript:void(0)" style="float: right; color: #fff; font-weight: bold;" onclick="PrevNext('<?php echo $mat["next"]; ?>');"><i
                            class="uk-icon-angle-double-right uk-icon-large" data-uk-tooltip="{pos:'left'}" title="Proximo" data-cached-title="Proximo"></i> </a>
        ...
        <label>
            ...
            <input name="matricula" type="text" class=" uk-text-center w_80 " id="matricula"
                   value="<?php if (isset($dadosassociado)): echo tool::CompletaZeros(10, $dadosassociado[0]->matricula); endif; ?>" readonly="readonly">

            <input name="empresaId" type="text" class=" uk-text-center w_80 " id="empresaId"
                   value="<?php if (isset($dadosassociado)): echo tool::CompletaZeros(3, $dadosassociado[0]->empresas_id); endif; ?>" readonly="readonly">
        ...
        <label>
            ...
            <input value="<?php if (isset($dadosassociado)):$now = new ActiveRecord\DateTime($dadosassociado[0]->dt_cadastro);
                echo $now->format('d/m/Y'); else: echo date("d/m/Y"); endif; ?>" type="text" class=" w_100 uk-text-center" name="dt_cadastro" id="dt_cadastro" readonly="readonly">
            <?php
        ...
        <label>
            ...
            <input value="<?php if (isset($dadosassociado)) {
                echo $dadosassociado[0]->nm_associado;
            } else {
            } ?>" type="text" class="w_400" name="nome" id="nome"/>
        </label>

        <label>
            <span>Telefones</span>
            <input type="text" class="dadosconta w_100 uk-text-center" value="<?php if (isset($dadosassociado)):echo tool::MascaraCampos("??-????-????", $dadosassociado[0]->fone_fixo); endif; ?>"
                   name="fone_fixo" id="fone_fixo" placeholder="Residencia"/>
            <input type="text" class=" w_100 uk-text-center" value="<?php if (isset($dadosassociado)):echo $dadosassociado[0]->fone_trabalho; endif; ?>" name="fone_trab" id="fone_trab"
            ...
            <a id="Btn_Sms" title="Enviar SMS"
               onClick="New_window('500','250','Envio de Mensagem','sms/Fr_SMS_Avulso.php?fone=<?php echo $dadosassociado[0]->fone_cel; ?>&msg=<?php echo base64_encode(""); ?>');"><i
                        class="icon-chat"></i></a>
        </label>
        <label>
            <span>Data Nasc</span>
            <input value="<?php if (isset($dadosassociado) && $dadosassociado[0]->dt_nascimento != null):$now = new ActiveRecord\DateTime($dadosassociado[0]->dt_nascimento);
                echo $now->format('d/m/Y'); else: echo "00/00/0000"; endif; ?>" type="text" class=" w_100 uk-text-center" name="data_nasc" id="data_nasc" placeholder="00/00/0000"/>
            <?php
            if (isset($dadosassociado)):
                $idde = tool::CalcularIdade($now->format("Y-m-d"), date("Y-m-d"));
                echo '<div class="uk-badge uk-badge-warning">( ' . $idde . ' ) Anos</div>';
        ...
        <label>
            ...
            <input value="<?php if (isset($dadosassociado)):echo tool::MascaraCampos("???.???.???-??", $dadosassociado[0]->cpf); endif; ?>" type="text" class=" w_120 uk-text-center" name="cpf"
        ...
        <label>
            ...
            <input value="<?php if (isset($dadosassociado)):echo $dadosassociado[0]->orgao_emissor_rg; endif; ?>" type="text" class=" w_100 uk-text-center" name="orgao_emissor_rg"
                   id="orgao_emissor_rg"/>
        </label>
        <label>
            <span>Data de emissão</span>
            <input value="<?php if (isset($dadosassociado)):$now = new ActiveRecord\DateTime($dadosassociado[0]->data_emissao_rg);
                echo $now->format('d/m/Y'); endif; ?>" type="text" class=" w_100 uk-text-center" name="data_emissao_rg" id="data_emissao_rg" placeholder="00/00/0000"/>
        </label>
        <label>
            <span>Casa Propria</span>
            <div class="uk-form-controls">
                <label>
                    <input type="radio" name="casa_propria" value="S" <?php if (isset($dadosassociado)) {
                        if ($dadosassociado[0]->casa_propria == "S") {
                            echo "checked";
                        }
                    } ?> > Sim
                    <input type="radio" name="casa_propria" value="N" <?php if (isset($dadosassociado)) {
                        if ($dadosassociado[0]->casa_propria == "N") {
                            echo "checked";
                        }
                    } ?> > Não
                </label>
        ...
        <label>
            ...
            <div class="uk-form-controls">
                <label>
                    <input type="radio" name="sexo" value="M" <?php if (isset($dadosassociado)) {
                        if ($dadosassociado[0]->sexo == "M") {
                            echo "checked";
                        }
                    } ?> > Masculino
                    <input type="radio" name="sexo" value="F" <?php if (isset($dadosassociado)) {
                        if ($dadosassociado[0]->sexo == "F") {
                            echo "checked";
                        }
                    } ?> > Feminino
                </label>
        ...
        <label>
            ...
            <div class="uk-form-controls">
                <label>
                    <input type="radio" name="estado_civil" value="C" <?php if (isset($dadosassociado)) {
                        if ($dadosassociado[0]->estado_civil == "C") {
                            echo "checked";
                        }
                    } ?> > Casado (a)
                    <input type="radio" name="estado_civil" value="S" <?php if (isset($dadosassociado)) {
                        if ($dadosassociado[0]->estado_civil == "S") {
                            echo "checked";
                        }
                    } ?> > Solteiro(a)
                    <input type="radio" name="estado_civil" value="V" <?php if (isset($dadosassociado)) {
                        if ($dadosassociado[0]->estado_civil == "V") {
                            echo "checked";
                        }
                    } ?> > Viuvo(a)
                    <input type="radio" name="estado_civil" value="A" <?php if (isset($dadosassociado)) {
                        if ($dadosassociado[0]->estado_civil == "A") {
                            echo "checked";
                        }
                    } ?> > Amasiado(a)
                    <input type="radio" name="estado_civil" value="D" <?php if (isset($dadosassociado)) {
                        if ($dadosassociado[0]->estado_civil == "D") {
                            echo "checked";
                        }
                    } ?> > Divorciado(a)
                </label>
            ...
            <select class="select w_400" name="vendedor" id="vendedor">
                ...
                if (isset($dadosassociado)):
                    ...
                    while ($descricao->valid()):
                        ...
                        if ($descricao->current()->id == $dadosassociado[0]->vendedores_id) {
        ...
        <label>
            ...
            <select class="select w_400" name="convenio" id="convenio">
                ...
                if (isset($dadosassociado)):
                    ...
                    while ($descricao->valid()):
                        ...
                        if ($descricao->current()->id == $dadosassociado[0]->convenios_id) {
                            $select = 'selected="selected"';
                        } else {
                            $select = "";
                        }
            ...
            <input value="<?php if (isset($dadosassociado)) {
                echo $dadosassociado[0]->convenios_id;
            } else {
            } ?>" type="hidden" name="cv_confirm" id="cv_confirm"/>
        ...
        <label>
            ...
            <select class="select w_400" name="uf" id="uf">
                ...
                if (isset($dadosassociado)):
                    ...
                    while ($descricao->valid()):
                        if ($descricao->current()->id == $dadosassociado[0]->estado_id) {
                            $select = 'selected="selected"';
                        } else {
                            $select = "";
                        }
            ...
            <button class="uk-button uk-button-small uk-button-primary" type="button" data-uk-modal="{target:'#dvuf'}"><i class="uk-icon-plus"></i> Adcionar</button>
        </label>
        <!-- -->
        <label>
            <span>cidade</span>
            ...
            <button class="uk-button uk-button-small uk-button-primary" type="button" data-uk-modal="{target:'#dvcid'}"><i class="uk-icon-plus"></i> Adcionar</button>
        </label>
        <!-- -->
        <label>
            ...
            <button class="uk-button uk-button-small uk-button-primary" type="button" data-uk-modal="{target:'#dvbair'}"><i class="uk-icon-plus"></i> Adcionar</button>
        </label>
        <!-- -->
        <label>
            ...
            <button class="uk-button uk-button-small uk-button-primary" type="button" data-uk-modal="{target:'#dvrua'}"><i class="uk-icon-plus"></i> Adcionar</button>
        </label>
        <label>
            <span>Complemento</span>
            <input name="compl_end" class=" w_300 uk-text-left" id="compl_end" value="<?php if (isset($dadosassociado)):echo $dadosassociado[0]->compl_end; endif; ?>" maxlength="20"
                   placeholder="Ex: Quadra,lote">
        </label>
        <label>
            <span>Numero</span>
        ...
        <label>
            ...
            <div class="uk-form-icon">
                ...
                <input name="cep" class="w_100 uk-text-center" id="cep" value="<?php if (isset($dadosassociado)):echo tool::MascaraCampos("?????-???", $dadosassociado[0]->cep); endif; ?>"
