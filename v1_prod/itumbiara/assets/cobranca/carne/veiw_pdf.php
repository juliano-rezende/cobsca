...
<!--.cp {font-size:10px; font-weight:bold; color:#000; padding-left:2px; line-height: 22px;}
<!--.ti {font-size:9px;}
...
<table width="100%" cellpadding="0" cellspacing="0">
  <tbody>
  <tr>
    <td width="17%" height="29" align="left" valign="bottom" style="border-right:1px dotted #000;">
    <table width="92%" border="0" cellspacing="0" style="border-bottom:0.2mm solid #000;">
      <tr>
        <td width="95" height="30" align="left" valign="top" style="vert-align: top;">
            <img src="imagens/001.jpg" alt="logo" width="100" height="30">
        </td>
      </tr>
    </table>
    </td>
    <td colspan="2" align="right" valign="bottom">
   <table width="100%" height="100%" border="0" cellspacing="0" style=" border-bottom:0.2mm solid #000;">
      <tr>
        <td width="115" height="32" valign="top" align="left"><img src="imagens/001.jpg" alt="logo" width="100" height="30"></td>
        <td width="72" align="center" valign="bottom" class="bc1" style="border-left:0mm solid #000; border-right:0mm solid #000;"></td>
  ...
  <tr>
    ...
    <table width="90%"  border="0" cellpadding="0" cellspacing="0" style="max-width:90%;" >
      ...
      <tr>
        <td class="ct" style=" border-left: #000000 0.1mm solid;  border-top: #000 0.1mm solid;" >Matricula</td>
      </tr>
      <tr>
        <td height="20" align="right" valign="bottom" class="cp" style=" border-left: #000000 0.1mm solid;padding-right:5px; " >'.$dadosboleto["matricula"].'</td>
      </tr>
      <tr>
        <td bgcolor="#f1f1f1" class="ct" style=" border-left: #000000 1px solid;  border-top: #000 0.1mm solid;" >(=) Valor</td>
      </tr>
      <tr>
       ...
       <tr>
        <td class="ct" style=" border-left: #000000 0.1mm solid;  border-top: #000 0.1mm solid;">Parcela nº</td>
      </tr>
      <tr>
        <td height="20" align="right" class="cp" style=" border-left: #000000 0.1mm solid;padding-right:5px;"  >'.$dadosboleto["numero_documento"].'</td>
      </tr>
      <tr>
        <td class="ct" style=" border-left: #000000 0.1mm solid;  border-top: #000 0.1mm solid;">Referência</td>
      </tr>
      <tr>
        <td height="20" align="center" class="cp" style=" border-left: #000000 0.1mm solid;  "  >'.$dadosboleto["referencia"].'</td>
      </tr>
      <tr>
        <td width="134"  align="left" valign="top" class="cn"  style=" border-left: #000000 0.1mm solid;border-top: #000 0.1mm solid; " >
            Associado<br> '.$dadosboleto["sacado"].'
        </td>
      </tr>
      <tr>
        <td height="50" valign="top" class="cn" style=" border-left: #000000 0.1mm solid; border-botton: #000 0.1mm solid; border-top: #000 0.1mm solid;">
          '.utf8_encode($dadosboleto["cedente"]) ." ".$dadosboleto["cpf_cnpj"].'
          '.$dadosboleto["endereco"] ." - ". $dadosboleto["cidade_uf"].'
        </td>
      </tr>
      <tr>
        <td height="20" align="center" class="cp" style=" border-left: #000000 0.1mm solid;">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:0; padding:0;">
      <tr>
        ...
        <table width="99%"  border="0" cellpadding="0" cellspacing="0" style="padding:0; margin:0;" >
          ...
          <tr>
            <td height="30" align="left"  class="cp" style="border-bottom:0.1mm solid #000;text-transform: uppercase;vertical-align: text-middle;" >'.strtolower($dadosboleto["local_pgto"]).'</td>
          </tr>
        </table>
        </td>
        <td width="100" rowspan="7" align="right" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0" style="max-width:90%;" >
          ...
          <tr>
            <td align="left" class="ct" style=" border-left: #000000 0.1mm solid;  border-top: #000 0.1mm solid;" >Matricula</td>
          </tr>
          <tr>
            <td height="25" align="right" valign="bottom" class="cp" style=" border-left: #000000 0.1mm solid;padding-right:5px; " >'.$dadosboleto["matricula"].'</td>
          </tr>
          <tr >
            <td align="left" class="ct" style=" border-left: #000000 0.1mm solid;  border-top: #000 0.1mm solid;">Parcela</td>
          </tr>
          <tr>
            <td height="25" align="right" class="cp" style=" border-left: #000000 0.1mm solid;padding-right:5px;"  >'.$dadosboleto["numero_documento"].'</td>
          </tr>
          <tr>
      ...
      <tr>
        ...
        <table width="99%"  border="0" cellpadding="0" cellspacing="0" style="padding:0;" >
          <tr>
            ...
            <td width="197" align="left" class="ct"  style="border-top:#ccc 0.1mm solid; border-right:#ccc 0.1mm solid;">Parcela nº</td>
            <td width="313" align="left" class="ct"  style="border-top:#ccc 0.1mm solid; border-right:#ccc 0.1mm solid;">Esp.Documento</td>
      ...
      <tr>
        <td align="right" valign="top"><table width="99%"  border="0" cellpadding="0" cellspacing="0" style="padding:0;" >
          <tr>
            <td align="left" class="ct" style="width:658px;border-top:#ccc 1px solid; border-right:#ccc 1px solid;"bgcolor="#f1f1f1">Tipo</td>
            <td align="left" class="ct" style="width:169px;border-top:#ccc 1px solid; ">Referência</td>
          </tr>
          <tr>
            <td height="20" align="left" valign="bottom" class="cp" style="border-right:#ccc 1px solid;border-bottom:#ccc 1px solid; " >'.$dadosboleto["carteira_descricao"].'</td>
            <td height="20" align="left" valign="bottom" class="cp" style="border-right:#ccc 1px solid;border-bottom:#ccc 1px solid; " >'.$dadosboleto["referencia"].'</td>
          </tr>
        </table></td>
        </tr>
      <tr>
        ...
        <table width="99%"  border="0" cellpadding="0" cellspacing="0" style="padding:0; margin:0;" >
          <tr>
            <td width="134" height="18" align="left" valign="bottom" class="ct" style="border-bottom:0.1mm solid #000; padding-top:5px; padding-bottom:3px;" >
