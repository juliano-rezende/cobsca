...
$queryfatu=associados::find_by_sql("SELECT SQL_CACHE
                                       ...
                                       faturamentos.valor,
                                       (SELECT sum(valor) FROM procedimentos WHERE valor > 0 and matricula  = associados.matricula and status='1' and faturamentos_id = faturamentos.id GROUP BY faturamentos_id) as valor_pro
                                    FROM
                                        faturamentos
            ...
            <tr>
              ...
              <table style="width:200mm;" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr class="tr_c">
                  ...
                  <td style="width:30mm;" class="cd border-bottom  border-right text-right"><?php echo $dadosboleto["agencia"]."/".$dadosboleto["codigo_cliente"]?></td>
            ...
            <tr>
              ...
              <table style="width:200mm;" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr class="tr_c">
                  ...
                  <td style="width:40mm;" class="cd border-bottom text-right "><?php echo $dadosboleto["agencia"]."/".$dadosboleto["codigo_cliente"]?></td>
                </tr>
              </table>
              <table style="width:200mm;" border="0" cellspacing="0" cellpadding="0">
                <tr class="tr_t">
