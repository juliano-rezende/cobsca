...
<meta name="author" content="Phpboleto">
...
#instr_header {
	background: url('../../../../../imagens/empresas/<?php echo $dadosboleto["logo"]; ?>.png') no-repeat top left;
	padding-left: 180px;
	height: 65px;
}
...
<div id="container" style="height: 980px">

	<div id="logo_header" style="position: absolute;">
	<img src="../../../../../imagens/empresas/<?php echo $dadosboleto["logo"]; ?>.png" alt="" style="height: 50px; width: 140px">
	</div>
	<div id="instr_header">
...
<!--
 ...
 -->
		...
		<div id="instr_content" style="padding-top: 25px;">

			<h2>Demonstrativo:</h2><br />
	...
	<div id="boleto">
		...
		<tbody>
		<tr>
			<td width=150><IMG SRC="../../imagens/756.jpg"></td>
			<td width=50>
		...
		<tbody>
		<tr class="titulos">
			<td class="cedente">Beneficiario</TD>
		...
		<tr class="campos">
			<td class="local_pagto"><?php echo $dadosboleto["local_pgto"]?></td>
		...
		<tbody>
		<tr class="titulos">
			<td class="cedente2">Beneficiario</td>
			<td class="ag_cod_cedente2">Ag&ecirc;ncia/C&oacute;digo cedente</td>
		</tr>
		<tr class="campos">
			<td class="cedente2"><?php echo $dadosboleto["cedente"]?> (<?php echo  isset($dadosboleto["cpf_cnpj"]) ? $dadosboleto["cpf_cnpj"] : '' ?>)</td>
		...
		<tr><td class="last_line" rowspan="6">
			...
			<tr class="titulos" style="height:66px;" valign="top">
			  <td >
              	<p><?php echo $dadosboleto["instrucoes1"]; ?></p>
                <p><?php echo $dadosboleto["instrucoes2"]; ?></p>
                <p><?php echo $dadosboleto["inst_adcional"]; ?></p>

              </td>
			  </tr>
			<tr class="campos">
				<td class="instrucoes" rowspan="5" style="border-top:1px solid #000; padding-left:2px; padding-bottom:5px;" valign="top">
                Pagador
                <p style="padding-top:3px; padding-left:6px; font-weight:bold;"><?php echo $dadosboleto["sacado"]?></p>
				<p style="padding-left:6px;font-weight:bold;"><?php echo $dadosboleto["endereco1"]?></p>
				<p style="padding-bottom:2px; padding-left:6px;font-weight:bold;"><?php echo $dadosboleto["endereco2"]?></p>
                </td>
			</tr>
			</tbody>
			</table>
		...
		<table width="100%" cellpadding="0" cellspacing="0" class="line" style="border:0;">
<tbody>
			<tr class="campos" style="border:0;">
            sacador / avalista
			<td class="sacador_avalista" style="border:0; padding:2px;"><?php fbarcode($dadosboleto["codigo_barras"]); ?></td>
			<td class="cod_baixa" style="border:0;" valign="top">Autenticação mecanica  - <strong style="font-size:10px;">Ficha de compensação</strong></td>
			</tr>
		</tbody>
		</table>
