...
$Query_all=faturamentos::find_by_sql("SELECT associados.nm_associado,faturamentos.matricula,faturamentos.dt_vencimento,faturamentos.titulos_bancarios_id,faturamentos.valor,faturamentos.obs,convenios.nm_fantasia
                                      FROM faturamentos
                                      ...
                                      WHERE faturamentos.dt_vencimento between '".$FRM_referencia."-01' AND '".$FRM_referencia."-31' AND faturamentos.status='0' AND faturamentos.empresas_id='".$COB_Empresa_Id."'");
...
?>
      ...
      <tr style="line-height:23px; <?php echo $color_error; ?>" >
        ...
        <td class="uk-width uk-text-center" style="width:100px;" ><?php echo $List_detalhes->current()->titulos_bancarios_id; ?></td>
