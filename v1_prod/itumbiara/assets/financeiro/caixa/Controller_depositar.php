...
if(empty($caixa_id)){
	...
	$tipolancamento			 	= "1";
	$tipo					 	= "c";
	$formas_recebimentos_id 	= isset( $_POST['formas_recebimentos_id'])	? $_POST['formas_recebimentos_id']:
	...
	$planos_contas_id			= isset( $_POST['planos_conta_id'])		? $_POST['planos_conta_id']:
