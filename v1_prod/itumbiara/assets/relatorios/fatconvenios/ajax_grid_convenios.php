...
$Query_associados=associados::find_by_sql("SELECT
                                           ...
                                           (SELECT valor FROM faturamentos WHERE matricula =  associados.matricula AND faturamentos.referencia='".$FRM_ref."' AND faturamentos.status='0' AND tipo_parcela='M' GROUP BY faturamentos.referencia) AS valor,
                                           convenios.cnpj,
