<div class="uk-modal-dialog" style="width:500px;">
		...
		<h2><i class="uk-icon-filter uk-icon-small" ></i> Filtro</h2>
                ...
                <div class="uk-form-icon">
                <i class="uk-icon-calendar"></i>
                <input name="dtfim" value="<?php echo date("d/m/Y"); ?>"  readonly="true" type="text" class="input_text w_100 center periodo" id="dtfim" data-uk-datepicker="{format:'DD/MM/YYYY'}"   />
                </div>
                </label>
