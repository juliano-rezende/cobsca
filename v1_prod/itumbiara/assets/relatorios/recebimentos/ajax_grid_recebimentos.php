...
<table  class="uk-table uk-table-striped uk-table-hover" style="font-size: 10px;" >
  <thead class="uk-hidden">
    ...
    <tr style="line-height:25px;">
      ...
      <th class="uk-width uk-text-center" style="width:90px;text-align: left;" >Telefones</th>
  ...
  ?>
      <tr style="line-height:22px;" class="<?php echo $class; ?>">
        ...
        <td class="uk-width uk-text-center " style="width:90px;" ><?php echo tool::MascaraCampos("??-????-????",$Listitles->current()->fone_fixo)." ".tool::MascaraCampos("??- ????-????",$Listitles->current()->fone_cel); ?></td>
