...
var matricula= jQuery('#matricula').val();
var empresaId = jQuery('#empresaId').val();
//New_window('file-text-o','950','550','Contrato de Adesão','assets/associado/contratos/'+ch_ctt+'/Contrato_adesao.php?matricula='+matricula+'',true,false,'Carregando...');
    ...
    window.open('assets/associado/contratos/' + empresaId+'/Contrato_adesao.php?matricula='+matricula+'', "_blank", "toolbar=no, scrollbars=no, resizable=no,top=20,left=10,width=980,height=500");
...
jQuery("#Btn_assoc_7").click(function(){
 ...
 jQuery("#Btn_assoc_14").click(function(){
     var matricula= jQuery('#matricula').val();
     New_window('file-text-o','950','550','Termo de Carteirinha','assets/associado/Termo_carterinha.php?matricula='+matricula+'',true,false,'Carregando...');
 });
...
jQuery(function(){
 ...
 jQuery("#Btn_assoc_13").click(function(){
     New_window('archive','550','270','Enviar para cobrança','assets/associado/Frm_cobranca.php',true,false,'Carregando...');
 });

/* funções */
/***************/
/* função para avançar e retroceder nos associaodos */
