...
if($acao=='disabled'){
	...
	if($erro_int){echo $erro_int;exit();}
...
$FRM_carterinha		=	isset( $_POST['Dep_cart'])?       $_POST['Dep_cart']:
                                                          $erro= '":"","callback":"1","msg":"Erro "DEP05-9" de Interno Contate o suporte!","matricula":"","status":"Danger';
...
if($FRM_cn =="" or  $FRM_cn=="0"){$erro= '":"","callback":"1","msg":"Os Campos Documentos não pode Ficar em Branco!","matricula":"'.$FRM_matricula.'","status":"warning';}

}

//VALIDA O PARENTESCO
if($FRM_parentesco=="" or $FRM_parentesco=="0"){$erro= '":"","callback":"1","msg":"Grau de Parentesco Invalido!","matricula":"'.$FRM_matricula.'","status":"warning';}


// verifica se a injeção de dados no formulario tais como alteração do nome do campo
if(isset($erro)){echo $erro; exit();}
...
if ( !$cpf_cnpj->valida() ) {
	sleep(1);
	$erro= '":"","callback":"1","msg":"Cpf Invalido!","matricula":"'.$queryFind->matricula.'","status":"danger';
}
...
// valida certidão de nascimento
if($FRM_cn =="" or  $FRM_cn=="0"){$erro= '":"","callback":"1","msg":"Os Campos Documentos não pode Ficar em Branco!","matricula":"'.$queryFind->matricula.'","status":"warning';}

}

//VALIDA O PARENTESCO
if($FRM_parentesco=="" or $FRM_parentesco=="0"){ $erro='":"","callback":"1","msg":"Grau de Parentesco Invalido!","matricula":"'.$queryFind->matricula.'","status":"warning';}
...
// VERIFICAMOS SE NÃO HOUVE ERROS E RETORNA A MSG
if(!$query){
	echo '":"","callback":"1","msg":"Erro ao Atualizar dependente","matricula":"'.$queryFind->matricula.'","status":"warning';
}else{
	echo '":"","callback":"0","msg":"Dependente Atualizado!","matricula":"'.$queryFind->matricula.'","status":"success';
}
