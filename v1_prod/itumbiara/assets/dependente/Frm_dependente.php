...
<form method="post" id="Frmdependente" class="uk-form" style="margin-top: 0; padding-top: 0;">
    ...
    <fieldset style="margin-top: 0; padding-top: 10px;">
        ...
        <label>
            ...
            <select class="select" name="Dep_cart" id="Dep_cart">
                <?php
                if ($FRM_action == "edit"):

                    if ($dependentes[0]->carteirinha == 0) {
                        echo '<option selected="selected"  value="0" >NÃO</option><option value="1" >SIM</option>';
                    } else {
                        echo '<option selected="selected"  value="1" >SIM</option><option value="0" >NÃO</option>';
                    }

                else:
                    echo '<option value="" selected="selected">Selecionar</option><option value="1" >SIM</option><option value="0" >NÃO</option>';
                endif;
                ?>
            </select>
        </label>
