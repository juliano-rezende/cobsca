...
?>
<a  id="Btn_det_0" class="uk-button uk-button-primary" style=" bottom:30px; position:absolute;  right:15px;" data-uk-tooltip="{pos:'left'}" title="Atualizar" data-cached-title="Atualizar" ><i class="uk-icon-check"></i> Atualizar </a>
<?php
}
?>
