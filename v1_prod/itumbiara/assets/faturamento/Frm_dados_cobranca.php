...
<a  id="Btn_confirm_cob" class="uk-button uk-button-primary " style="position:absolute;; right:15px; bottom:30px; z-index:2;" data-uk-tooltip="{pos:'left'}" title="Confirmar dados" data-cached-title="Confirmar dados" ><i class="uk-icon-check"></i> Confirmar</a>
