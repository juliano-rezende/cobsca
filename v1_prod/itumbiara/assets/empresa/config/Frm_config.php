...
<div id="menu-float" style="text-align:center;margin:0 800px;top:33px;border:0;background-color:#546e7a;">
...
<form method="post" id="FrmConfigs" class="uk-form" style=" width:900px;  padding-top:0; margin:0;">
    ...
    <fieldset style="width:778px; left:5px; top:30px; position:absolute;">
        <legend class="uk-gradient-cinza" style="padding:5px 10px 5px 10px;">Configurações Gerais</legend>
        <div class="uk-grid">
            <div class="uk-width-1-4">
                <label>
                    <span>Juros mora</span>
                    <div class="uk-badge uk-badge-notification" style="position: absolute; margin: -20px 120px;">Mensal</div>
                    <input value="<?php if (isset($dadosconfig)):echo $dadosconfig->juros; endif; ?>" name="juros" type="text" class="uk-text-center w_100 " id="juros"/>
            ...
            <div class="uk-width-1-4">
                <label>
                    ...
                    <input value="<?php if (isset($dadosconfig)):echo $dadosconfig->multa; endif; ?>" name="multa" type="text" class="uk-text-center w_100 " id="multa"/>
                    <div class="uk-badge uk-badge-warning">%</div>
                </label>
            </div>
            ...
            <div class="uk-width-1-4">
                <label>
                    ...
                    <div class="uk-badge uk-badge-notification" style="position: absolute; margin: -20px 120px;">Carencias</div>
                    <input value="<?php if (isset($dadosconfig)):echo $dadosconfig->carencia; endif; ?>" name="carencia" type="text" class="uk-text-center w_100 " id="carencia"/>
                    <div class="uk-badge uk-badge-warning">dias</div>
                </label>
            </div>
            <div class="uk-width-1-4">
                <label>
                    <span>Integração</span>
                    <input value="<?php if (isset($dadosconfig)):echo $dadosconfig->carencia1; endif; ?>" name="carencia1" type="text" class="uk-text-center w_100 " id="carencia1"/>
                    <div class="uk-badge uk-badge-warning">dias</div>
                </label>
            </div>
        </div>
                    ...
                    <select name="centro_custo_id" id="centro_custo_id" class="select" style="width: 100%;">
                        ...
                        while ($Arr_c_custos->valid()):
                            ...
                            while ($Arr_c_custos1->valid()):
                                ...
                                if ($Arr_c_custos1->current()->id == $dadosconfig->centros_custos_id) {
                    ...
                    <select name="plano_conta_id" id="plano_conta_id" class="select" style="width: 100%;">
                        ...
                        while ($Arr_conta->valid()):
                            ...
                            while ($Arr_planos1->valid()):
                                ...
                                if ($Arr_planos1->current()->id == $dadosconfig->planos_contas_id) {
                                    $select = 'selected="selected"';
                                } else {
                                    $select = "";
                                }
                    ...
                    <select name="plano_conta_id_d" id="plano_conta_id_d" class="select" style="width: 100%;">
                        ...
                        while ($Arr_conta->valid()):
                            ...
                            while ($Arr_planos1->valid()):
                                ...
                                if ($Arr_planos1->current()->id == $dadosconfig->planos_contas_id_d) {
                                    $select = 'selected="selected"';
                                } else {
                                    $select = "";
                                }
    ...
    <fieldset style="width:778px; left:5px; top:205px; position:absolute;">
        ...
        <div class="uk-grid">
            <div class="uk-width-1-3">
                <label>
                    <span>< 200 </span>
                    <input value="<?php if (isset($dadosconfig)):echo $dadosconfig->desc_um; endif; ?>" name="desc_um" type="text" class="uk-text-center w_100 " id="desc_um"/>
            ...
            <div class="uk-width-1-3">
                <label>
                    <span>200 <> 300 </span>
                    <input value="<?php if (isset($dadosconfig)):echo $dadosconfig->desc_dois; endif; ?>" name="desc_dois" type="text" class="uk-text-center w_100 " id="desc_dois"/>
                    <div class="uk-badge uk-badge-success">%</div>
                </label>
            </div>
            <div class="uk-width-1-3">
                <label>
                    <span>300 <> 400 </span>
                    <input value="<?php if (isset($dadosconfig)):echo $dadosconfig->desc_tres; endif; ?>" name="desc_tres" type="text" class="uk-text-center w_100 " id="desc_tres"/>
                    <div class="uk-badge uk-badge-success">%</div>
                </label>
            </div>
        </div>
        ...
        <div class="uk-grid">
            <div class="uk-width-1-3">
                <label>
                    <span>400 <> 500 </span>
                    <input value="<?php if (isset($dadosconfig)):echo $dadosconfig->desc_quatro; endif; ?>" name="desc_quatro" type="text" class="uk-text-center w_100 " id="desc_quatro"/>
                    <div class="uk-badge uk-badge-success">%</div>
                </label>
            </div>
            <div class="uk-width-1-3">
                <label>
                    <span>500 <> 600 </span>
                    <input value="<?php if (isset($dadosconfig)):echo $dadosconfig->desc_cinco; endif; ?>" name="desc_cinco" type="text" class="uk-text-center w_100 " id="desc_cinco"/>
                    <div class="uk-badge uk-badge-success">%</div>
                </label>
            </div>
            <div class="uk-width-1-3">
                <label>
                    <span>600 <> 700 </span>
                    <input value="<?php if (isset($dadosconfig)):echo $dadosconfig->desc_seis; endif; ?>" name="desc_seis" type="text" class="uk-text-center w_100 " id="desc_seis"/>
                    <div class="uk-badge uk-badge-success">%</div>
                </label>
            </div>
        </div>
        ...
        <div class="uk-grid">
            <div class="uk-width-1-3">
                <label>
                    <span>700 <> 800 </span>
                    <input value="<?php if (isset($dadosconfig)):echo $dadosconfig->desc_sete; endif; ?>" name="desc_sete" type="text" class="uk-text-center w_100 " id="desc_sete"/>
                    <div class="uk-badge uk-badge-success">%</div>
                </label>
            ...
            <div class="uk-width-1-3">
                <label>
                    <span>800 <> 900 </span>
                    <input value="<?php if (isset($dadosconfig)):echo $dadosconfig->desc_oito; endif; ?>" name="desc_oito" type="text" class="uk-text-center w_100 " id="desc_oito"/>
                    <div class="uk-badge uk-badge-success">%</div>
                </label>
            </div>
            <div class="uk-width-1-3">
                <label>
                    <span>> 900 </span>
                    <input value="<?php if (isset($dadosconfig)):echo $dadosconfig->desc_nove; endif; ?>" name="desc_nove" type="text" class="uk-text-center w_100 " id="desc_nove"/>
                    <div class="uk-badge uk-badge-success">%</div>
                </label>
            </div>
        </div>
    ...
    <fieldset style="width:778px; left:5px; top:423px; position:absolute;">
        ...
        <div class="uk-grid">
            ...
            <div class="uk-width-1-3">
                <label>
                    ...
                    <input value="<?php if (isset($dadosconfig)):echo number_format($dadosconfig->vlr_apol_seg, 2, ",", "."); endif; ?>" name="vlr_apol_seg" type="text" class="uk-text-center w_100 " id="vlr_apol_seg"/>
                    <div class="uk-badge uk-badge-warning">R$</div>
                </label>
            </div>
            <div class="uk-width-1-3">
                <label>
                    <span>Valor Funeral</span>
                    <input value="<?php if (isset($dadosconfig)):echo number_format($dadosconfig->vlr_aux_fun, 2, ",", "."); endif; ?>" name="vlr_aux_fun" type="text" class="uk-text-center w_100 " id="vlr_aux_fun"/>
                    <div class="uk-badge uk-badge-warning">R$</div>
                </label>
            </div>
            <div class="uk-width-1-3">
                <label>
                    ...
                    <input value="<?php if (isset($dadosconfig)):$now = new ActiveRecord\DateTime($dadosconfig->validade_apolice);
                        echo $now->format('d/m/Y'); endif; ?>" name="validade_apolice" type="text" class="uk-text-center w_100 " id="validade_apolice"/>
                </label>
            </div>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        jQuery("#validade_apolice").mask("99/99/9999");
        jQuery("#cnpj_seg").mask("99.999.999/9999-99");
