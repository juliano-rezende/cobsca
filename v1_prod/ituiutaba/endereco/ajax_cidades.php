...
$cidades_encontrados=cidades::find_by_sql("SELECT DISTINCT descricao,id FROM cidades WHERE estados_id='".$_POST['cdestado']."'  GROUP BY descricao ORDER BY descricao ASC");
