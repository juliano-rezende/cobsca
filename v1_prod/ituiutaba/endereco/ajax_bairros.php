...
$bairros_encontrados=bairros::find_by_sql("SELECT DISTINCT descricao,id FROM bairros WHERE cidades_id='".$_POST['cdcidade']."' GROUP BY descricao ORDER BY descricao ASC");
