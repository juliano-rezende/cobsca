...
<div class="uk-vertical-align-middle" style="width: 400px; height: 350px;" >
	<div class="uk-panel uk-panel-box ">
		...
		<input class="uk-width-1-1 uk-form-large uk-text-uppercase" type="text" placeholder="LOGIN" id="login" autocomplete="off" style="height: 40px;"></div>
		<div class="uk-form-row">
		<input class="uk-width-1-1 uk-form-large" type="password" autocomplete="off" placeholder="SENHA" id="senha" onKeyPress="if ((window.event ? event.keyCode : event.which) == 13) { Login(); }" style="height: 40px;">
		<a href="" class="uk-form-password-toggle" data-uk-form-password="" style="margin:10px 30px;">Show</a>
		</div>
		<div class="uk-form-row">
		<a class="uk-width-1-1 uk-button uk-button-primary uk-button-large" id="Btn_login" style="border-radius:0; border:0; line-height: 40px;"  onclick="Login();">ACESSAR SISTEMA</a>
		</div>
		...
		<div class="uk-form-row uk-text-small"><label>Versão 3.1</label> </div>
		</form>
	</div>
</div>
