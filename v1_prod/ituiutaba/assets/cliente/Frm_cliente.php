...
<fieldset style="width:870px;">
        ...
        <label >
            ...
            echo tool::CompletaZeros("11",$dadoscliente[0]->id); endif; ?>"  name="cliente_id" type="text" class=" w_100 uk-text-center " readonly id="cliente_id"  />
		<?php  if(isset($dadoscliente)): ?>
        ...
        <label id="lab01">
            <span>Nome</span>
            <input value="<?php  if(isset($dadoscliente)):
            echo $dadoscliente[0]->nm_cliente; endif; ?>"  name="nm_cliente" type="text" class="w_400 " id="nm_cliente"  />
        </label>
        <label id="lab02">
            <span>Razão Social</span>
            <input value="<?php  if(isset($dadoscliente)):
            echo $dadoscliente[0]->razao_social; endif; ?>"  name="rzsc" type="text" class="w_400 " id="rzsc"  />
        </label>
        <label id="lab03">
            <span>Nome Fantasia</span>
            <input value="<?php  if(isset($dadoscliente)):
            echo $dadoscliente[0]->nm_fantasia; endif; ?>"  name="nmfant" type="text" class="uk-text-left w_400 " id="nmfant"  />
        </label>
        ...
        <label id="lab05">
            <span>Cnpj</span>
            <input value="<?php  if(isset($dadoscliente)):echo $dadoscliente[0]->cnpj; endif; ?>"  name="cnpj" type="text" class=" w_150 uk-text-center" id="cnpj"  />
        </label>
        <label id="lab06">
            <span>Rg</span>
        ...
        <label id="lab07">
            <span>Isc.Est</span>
            <input value="<?php if(isset($dadoscliente)):echo $dadoscliente[0]->ie; endif; ?>" name="ie" type="text" class=" w_100 uk-text-center" id="ie"  />
        </label>
        <label id="lab08">
            <span>Isc.Mun</span>
            <input value="<?php if(isset($dadoscliente)):echo $dadoscliente[0]->im; endif; ?>" name="im" type="text" class=" w_100 uk-text-center" id="im"  />
        </label>
        <label>
            <span>Fone fixo</span>
...
<!-- -->
    ...
    <label>
        <span>Numero</span>
        <input name="num" class=" w_100 uk-text-center" id="num"  value="<?php if(isset($dadoscliente)):echo $dadoscliente[0]->num; endif; ?>" maxlength="9" >
    </label>
   <label>
        <span>Cep</span>
        <div class="uk-form-icon">
