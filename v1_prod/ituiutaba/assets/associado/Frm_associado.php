...
<?php } ?>
    ...
    <label>
        ...
        <select class="select w_400" name="vendedor"  id="vendedor" >
            ...
            echo'<option value="'.$descricao->current()->id.'" '.$select.'>'.(strtoupper($descricao->current()->nm_vendedor)).'</option>';
            ...
            while($descricao->valid()):
            echo'<option value="'.$descricao->current()->id.'" >'.(strtoupper($descricao->current()->nm_vendedor)).'</option>';
            $descricao->next();
            endwhile;
            endif;
            ?>
