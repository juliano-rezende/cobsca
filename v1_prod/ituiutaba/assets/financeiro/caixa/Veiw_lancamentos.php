...
<div id="DvFiltroResumo" class="uk-modal">

    <?php include "../../../assets/financeiro/caixa/ajax/ajax_filtro_resumo.php"; ?>
...
<div style="float:left;  padding-right: 10px; width:100%; border-top:2px solid #ccc; " class="uk-width-10-10 uk-gradient-cinza">
    ...
    <div class="uk-button-group group_button" style="border:0px solid #ccc;float:right; margin-top: 1px; ">
        ...
        <a href="JavaScript:void(0);" id="Btn_rec_op" class="uk-button uk-button-success uk-button-small" data-uk-modal="{target:'#DvFiltroResumo'}" style="border-left:1px solid #ccc;padding-top:2px;line-height: 30px;"><i class="uk-icon-user "></i> Resumos de recebimentos</a>

        <?php if ($COB_Acesso_Id != 1): ?>
            ...
            <a href="JavaScript:void(0);" id="Btn_caixa_02" class="uk-button uk-button-primary  uk-button-small " onClick="PosicaoPainel('Btn_Contas','Dvconta');" style="border-left:1px solid #ccc;padding-top:2px;line-height: 30px;"><i class="uk-icon-upload "></i> Retirar dinheiro</a>
        <?php else: ?>
            <a href="JavaScript:void(0);" id="Btn_caixa_02" class="uk-button uk-button-primary  uk-button-small " onClick="PosicaoPainel('Btn_Contas','Dvconta');" style="border-left:1px solid #ccc;padding-top:2px;line-height: 30px;"><i class="uk-icon-upload "></i> Retirar dinheiro</a>
        <?php endif; ?>
    </div>
...
<div style="float: left;" class="uk-width-10-10">
    ...
    <table class="uk-table">
        ...
        <tr style="line-height:30px;">
            ...
            <th class="uk-width uk-text-center" style="width:150px; color:#666;">F-PGTO</th>
...
Carregando Grid...
    ...
    <script type="text/javascript">
        ...
        jQuery("#gridlancamentos").load('assets/financeiro/caixa/Grid_lancamentos.php?conta_id=' + jQuery("#conta_id_alt").val() + '&periodo=7');
