...
?>
      ...
      <tr style="line-height:22px;" class="<?php echo $class; ?>">
        ...
        <td class="uk-width uk-text-center" style="width:90px;"><?php echo $Listitles->current()->nosso_numero; ?></td>
        ...
        <td class="uk-width uk-text-center" style="width:120px; vertical-align: middle;" >
          ...
          <div class="uk-coment-action" style="font-weight: normal; text-align: left; z-index: 10000;">
          ...
          <div data-uk-dropdown="{pos:'left-center',mode:'click'}">
            ...
            <div class="uk-dropdown uk-dropdown-small">
              <ul class="uk-nav uk-nav-dropdown">
                ...
                <li><a  onclick="ActionsTitle('print','<?php echo $Listitles->current()->cod_banco; ?>','<?php echo $Listitles->current()->convenios_id; ?>','<?php echo $dt_ref->format('Y-m-d'); ?>','<?php echo $Listitles->current()->id; ?>');"><i class="uk-icon-print"></i> Imprimir</a></li>
              </ul>
            </div>
          </div>
        </div>
